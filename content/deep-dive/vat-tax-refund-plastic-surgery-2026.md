...
If you're considering procedures, check out our [guide to plastic surgery costs in Korea](/blog/korea-plastic-surgery-cost-guide-2026) for a full price breakdown.

<KeyTakeaways 
  points={[
    "The South Korean government decided not to extend the 'Special Tax Treatment' for cosmetic procedures into 2026, so you can no longer get that 7-8% cash back at the airport kiosks for surgeries performed after New Year's Day.",
    "On a 10,000,000 KRW ($7,200) jaw contouring surgery, you are looking at a 1,000,000 KRW tax bill that you used to get back—that is literally enough to buy a round-trip ticket from Singapore or a whole new wardrobe in Myeongdong.",
    "If you want to keep your savings, book through platforms like Creatrip that offer a 10% 'Beauty Cashback' in points until June 30, 2026, effectively replacing the government's old program."
  ]}
  readTime={15}
...
<QuickFacts
  title="2026 Medical VAT Refund Quick Facts"
  facts={[
    { label: "2026 Medical VAT Refund Rate", value: "0% (Abolished)", icon: "🚫" },
    { label: "Retail Tax Refund Min Spend", value: "₩15,000 per receipt", icon: "🧾" },
    { label: "Creatrip Beauty Cashback", value: "10% (Until June 30, 2026)", icon: "💰" }
  ]}
  columns={3}
/>
...
<Timeline
  title="Korean Medical VAT Refund History"
  items={[
    { time: "2016", title: "Program Launch", description: "Korea introduced the VAT refund to jumpstart the medical tourism industry.", icon: "🚀" },
    { time: "2019", title: "All-Time High", description: "Nearly 500,000 foreign patients visited Korea, proving the tax incentive worked.", icon: "📈" },
    { time: "2024", title: "Record Refunds", description: "The government issued over ₩95 billion in refunds, signaling the program's massive scale.", icon: "💳" },
    { time: "July 2025", title: "The 'Scrap' News", description: "The Ministry of Economy and Finance announced plans to end the medical tax break.", icon: "📰" },
    { time: "Dec 2025", title: "Final Decision", description: "The National Assembly omitted the extension from the final tax revision.", icon: "⚖️" },
    { time: "Jan 1, 2026", title: "The Sunset", description: "The VAT refund for cosmetic surgery officially expires for all international patients.", icon: "🌅" }
  ]}
/>
...
For a detailed look at what treatments are still available, check out [anti-aging treatments in Korea including Botox and fillers](/blog/anti-aging-treatments-in-korea-botox-fillers-and-more-2026).

## Breaking Down Your 2026 Options

<ComparisonTable
  title="2026 Tax Refund Options Compared"
  headers={["Feature", "Old Govt Refund (Pre-2026)", "Creatrip Cashback (2026)", "Retail Tax Refund (2026)"]}
  rows={[
    { feature: "Cost Back", option1: "~7% net (after fees)", option2: "10% (in reward points)", option3: "5-8% net" },
    { feature: "Processing Time", option1: "Instant at Airport", option2: "Within 30 days of review", option3: "Immediate at register" },
    { feature: "Required Form", option1: "Medical Service Certificate", option2: "Simple Receipt + Review", option3: "Passport only" },
    { feature: "Max Limit", option1: "No specific cap", option2: "Varies by clinic promo", option3: "₩5,000,000 total trip" },
    { feature: "Best For", option1: "Major surgeries (Historical)", option2: "Dermatology and Skin care", option3: "Shopping at Olive Young" },
    { feature: "2026 Status", option1: "EXPIRED", option2: "Active until June 30, 2026", option3: "Active and Limits Increased" }
  ]}
/>
...
Wondering what to buy? See our complete [tax refund for tourists guide](/blog/tax-refund-for-tourists-how-to-claim) for the full process.
...
<ProsCons
  title="Private Cashback Option: Pros and Cons"
  pros={[
...
<StepGuide
  title="How to Claim Your 10% Beauty Cashback in 2026"
  totalTime="20 Minutes"
  difficulty="easy"
  steps={[
    {
      title: "Book via a Participating Platform",
      description: "Look for clinics on the Creatrip or Unni apps that display the '10% Back' or 'Cashback' badge before you even leave your home country.",
      tip: "Make sure the 'payment date' on the platform matches your actual appointment to avoid verification issues later."
    },
    {
      title: "Pay On-Site and Keep the Receipt",
      description: "After your treatment, pay the clinic directly and ask for a detailed receipt that shows the clinic name, date, and amount in KRW.",
      tip: "Take a clear photo of the receipt immediately; thermal paper receipts from Korean clinics fade remarkably fast in your wallet."
    },
    {
      title: "Write Your Review",
      description: "Log back into the app and upload 1-2 photos of your results (or the clinic interior) along with a short 2-3 sentence review of your experience.",
      tip: "You have exactly 30 days to do this; if you miss the window, that 10% is gone forever with no appeals process."
    },
    {
      title: "Redeem Your Points",
      description: "Once the app verifies your receipt (usually takes a few days), your points will appear in your wallet to be used for future bookings or travel perks.",
      tip: "Use these points to book your airport limousine bus or KTX tickets for the rest of your trip to save real cash."
    }
  ]}
/>
...
For more about choosing the right clinic, read our guide on the [best plastic surgery clinics for foreigners in Seoul](/blog/best-plastic-surgery-clinics-for-foreigners-in-seoul).
...
<InfoBox type="tip" title="Pro Tip: Cash Discount">
...
<InfoBox type="warning" title="Beware of Unregistered Brokers">
...
<FAQAccordion
  items={[
    {
      question: "I'm getting a nose job in March 2026. Can I get a tax refund?",
      answer: "Unfortunately, no. The official government program for cosmetic surgery VAT refunds ended on December 31, 2025. You will pay the full price including the 10% tax, unless the clinic is part of a private cashback event."
    },
    {
      question: "Does this mean I can't get tax refunds at Olive Young anymore?",
      answer: "No, you're in luck! Shopping refunds for clothes and makeup are part of a totally different program that is still running and actually had its limits increased for 2026."
    },
    {
      question: "What happens if I paid a deposit in 2025 for a 2026 surgery?",
      answer: "If you paid the bill in full before January 1, 2026, you might still be able to claim the refund when you depart, provided you leave Korea within 3 months of that payment."
    },
    {
      question: "How much money am I actually losing without the refund?",
      answer: "On average, people used to get back about ₩150,000 to ₩300,000 per trip. While it doesn't sound like a fortune, that's definitely a couple of fancy dinners or a high-end skincare haul."
    },
    {
      question: "Is Korea still the cheapest place for plastic surgery?",
      answer: "Even with the 10% tax stay, Korea's base prices for things like Rejuran Healer or Double Eyelid Surgery are often 50% cheaper than in the US or Europe, so it's still a massive win for your wallet."
    }
  ]}
/>
...
- [VATupdate.com](https://www.vatupdate.com/2025/08/29/south-korea-extends-vat-refund-for-cosmetic-surgery-tourists-to-2026/) - Data on the 2025 legislative bill and its eventual status
- [Creatrip Official](https://creatrip.com/en/news/14936) - Comprehensive breakdown of the tax cancellation and the 10% Beauty Cashback details
- [Korea JoongAng Daily](https://koreajoongangdaily.joins.com/news/2025-12-18/business/industry/Foreign-tourists-rushing-to-cosmetic-clinics-before-longtime-VAT-refund-program-ends-/2478655) - Confirmation of the National Assembly's decision and industry reactions
- [Korea Customs Service](https://www.customs.go.kr/english/cm/cntnts/cntntsView.do?mi=10803&cntntsId=5504) - Official procedures for general tourist tax refunds at airports
- [Medical Korea (KHIDI)](https://www.medicalkorea.or.kr/) - Historical statistics on medical tourism growth and center relocation details
