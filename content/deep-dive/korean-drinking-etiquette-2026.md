...
<KeyTakeaways 
  points={[
    ...
    "Here's the deal with the money: A bottle of soju in a standard Seoul restaurant in 2026 will set you back between ₩5,000 and ₩7,000. That's roughly the price of two fancy lattes, so while it's not as dirt-cheap as it was ten years ago, it's still the most affordable way to get a buzz.",
    "If you want to survive a night out, you've got to master the 'Anju' (food) and 'Hangover' game. Never drink on an empty stomach because most bars actually require you to order food anyway, and always grab a 'Condition' or 'IdH' pear drink at the GS25 or CU convenience store before you hit the hay."
  ]}
  readTime={15}
...
<QuickFacts
  title="Korean Drinking Culture Quick Facts"
  facts={[
    { label: "Average Soju Bottle (Restaurant)", value: "₩5,000 - ₩8,000", icon: "🍶" },
    { label: "Standard Soju Alcohol Content", value: "14.9% (2026 average)", icon: "📊" },
    { label: "Hangover Drink Price", value: "₩3,000 - ₩5,500", icon: "💊" },
    { label: "Classic Somaek Ratio", value: "3:7 (Soju:Beer)", icon: "🍺" }
  ]}
  columns={2}
/>
...
<Timeline
  title="Korean Drinking Culture History"
  items={[
    { time: "1200s", title: "Mongol Invasion", description: "Distillation techniques from Persia arrive in Goryeo, creating the first Korean soju.", icon: "🏺" },
    { time: "1909", title: "Colonial Brewing Ban", description: "Japanese authorities ban home brewing, ending centuries of diverse local family recipes.", icon: "🚫" },
    { time: "1965", title: "Grain Management Act", description: "Government bans rice for alcohol due to shortages; distillers turn to sweet potatoes and tapioca.", icon: "🍠" },
    { time: "2007", title: "Forced Drinking Ban", description: "Seoul High Court rules against companies forcing employees to binge drink at company dinners.", icon: "⚖️" },
    { time: "2025", title: "Hangover Cure Regs", description: "New laws require companies to clinically prove that hangover drinks actually work by October.", icon: "💊" },
    { time: "2026", title: "The Price Paradox", description: "Alcohol prices in restaurants show a rare decline as the MZ generation pivots to non-alcoholic options.", icon: "📉" }
  ]}
/>
...
<ComparisonTable
  title="Korean Drinking Venues Compared"
  headers={["Feature", "Pojangmacha (Tent Bar)", "Suljip (Classic Pub)", "Hof (Beer Hall)", "Izakaya (Japanese Style)"]}
  rows={[
    { feature: "Cost", option1: "₩-₩₩ (Cheap to Mid)", option2: "₩₩ (Moderate)", option3: "₩₩ (Moderate)", option4: "₩₩₩ (Expensive)" },
    { feature: "Best For", option1: "Late night nostalgia", option2: "Large friend groups", option3: "Chicken & Beer", option4: "Dates/Quiet talks" },
    { feature: "Vibe", option1: "Gritty, street-side", option2: "High energy, loud", option3: "Casual, cozy", option4: "Dimly lit, private" },
    { feature: "Must-Order", option1: "Udon, Soju", option2: "Fruit Soju, Stews", option3: "Fried Chicken", option4: "Sashimi, Highballs" },
    { feature: "2026 Trends", option1: "Urban revival areas", option2: "Neon/Cyberpunk decor", option3: "Craft beer focus", option4: "Premium craft sake" },
    { feature: "Requirements", option1: "Cash/Card (no reservation)", option2: "Walk-ins usually fine", option3: "Group seating focus", option4: "Often needs reservation" }
  ]}
/>
...
<ProsCons
  title="Following Traditional Drinking Etiquette"
  pros={[
...
<StepGuide
  title="How to Survive Your First 'Hoesik' (Company Dinner)"
  totalTime="3-5 hours"
  difficulty="medium"
  steps={[
    {
      title: "The Seating Power Move",
      description: "Wait for the most senior person (the boss or oldest friend) to sit down first. They always get the 'upper seat' (sangseok), which is usually the one furthest from the door or the most comfortable booth.",
      tip: "If you're the youngest, sit closest to the door so you can easily flag down the server or grab extra napkins."
    },
    {
      title: "The First Pour Dance",
      description: "When the boss picks up the bottle, hold your glass with both hands (right hand around the glass, left hand supporting the bottom). Once they pour yours, grab the bottle with two hands and return the favor immediately.",
      tip: "Never, ever let a superior's glass stay empty for more than a minute. It's considered a sign of inattentiveness."
    },
    {
      title: "The Secret Sip",
      description: "When it's time to drink, turn your head to the side (away from the oldest person) and cover your mouth and glass with your hand while you swallow. This is a sign of modesty and respect.",
      tip: "If you want to slow down, leave your glass half-full. People won't refill it until it's totally empty!"
    },
    {
      title: "The Game Phase",
      description: "As the night goes on, someone will inevitably start a drinking game like Noonchi or 3-6-9. Just follow the rhythm, clap when everyone else claps, and don't be afraid to make a fool of yourself—it's how you bond!",
      tip: "Mastering the 'Soju Bottle Cap Flick' is the fastest way to become the MVP of the night."
    }
  ]}
/>
...
<ExpertTip
  name="Min-ji Kim"
  role="Corporate Culture Consultant"
  experience="12 years in Seoul"
  quote="In 2026, the 'Medical Excuse' is your best friend. If you really can't drink but want to stay for the party, just say you're on antibiotics. Koreans take health very seriously, and it's the one excuse that no boss will ever push back on. You can still participate in the toasts with water or soda!"
/>
...
<InfoBox type="warning" title="Warning: Never Use One Hand">
...
<FAQAccordion
  items={[
    {
      question: "Can I pour my own drink if I'm sitting alone?",
      answer: "Honestly, yeah. If you're eating solo at a gukbap place, nobody cares. But if you're with even one other person, it's polite to pour for them and have them pour for you. Drinking alone in a group setting is seen as being 'outside' the circle."
    },
    {
      question: "What is 'Somaek' and why is everyone drinking it?",
      answer: "Somaek is a mix of Soju and Maekju (Beer). Usually, it's a 3:7 ratio. People love it because it masks the harsh chemical taste of cheap soju and goes perfectly with fried chicken or BBQ."
    },
    {
      question: "Is it okay to use metal chopsticks for everything?",
      answer: "Koreans use metal chopsticks for meat and veggies, but they always use a spoon for rice and soup. If you try to eat rice with chopsticks, it looks a bit weird to locals—plus, the metal ones are slippery!"
    },
    {
      question: "How do I handle the bill at the end of the night?",
      answer: "Usually, the oldest person or the 'boss' pays for everyone. However, with the MZ generation, 'N-bbang' (splitting the bill) is becoming way more common. If you're a guest, offer to pay, but be prepared for them to insist on treating you."
    },
    {
      question: "What's the deal with the 'green bottles' of soju?",
      answer: "That's the 'diluted' soju. It's mass-produced and cheap. In 2026, there's a big move toward 'Distilled Soju' (premium stuff like Hwayo or Won Soju). If you want a better experience (and fewer headaches), spend the extra few thousand won for the clear bottles."
    }
  ]}
/>
...
1. Download Catchtable Global and Naver Maps (Google Maps is basically useless here).
2. Go to a local Suljip, order some Kimchi-jeon (pancake) and a bottle of Makgeolli (rice wine).
3. Practice the "Two-Hand Pour" with your travel buddy.
...
- [Visit Korea (Official Tourism)](https://english.visitkorea.or.kr/svc/contents/contentsView.do?vcontsId=205615) - Info on Catchtable Global and tourist booking systems.
- [The Korea Herald](https://www.koreaherald.com/article/10526937) - Data on 2025/2026 alcohol price trends in restaurants.
- [The Guardian](https://www.theguardian.com/world/2025/sep/28/south-korea-hangover-cures-booming-market-traditional-novel-remedies-k-cure) - Research on the hangover cure market and new 2025/2026 regulations.
- [Morning Calm (Korean Air)](https://morningcalm.koreanair.com/en/issues/sep-oct-2025/a-sip-of-korean-heritage) - Historical timeline and craft soju revival details.
- [K-Campus](https://kcampus.kr/real-life-reviews/how-to-use-korean-delivery-apps-without-an-arc-korean-phone-number-6983) - Guide for ordering delivery without an ARC.
