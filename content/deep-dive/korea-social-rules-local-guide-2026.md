...
<KeyTakeaways 
  points={[
    "Respect is the currency here, and it's almost always tied to age and hierarchy. Whether you're pouring a drink or handing over your credit card, always use two hands to show you understand the weight of 'kibun' (social harmony).",
    "In 2026, the legal minimum wage has officially crossed the ₩10,000 threshold (₩10,320 to be exact), which is why the anti-tipping sentiment is stronger than ever; locals see any attempt at 'creeping Americanization' of service as an insult to price transparency and worker dignity.",
    "If you want to move like a local, master the digital-physical hybrid life: download the right workarounds for the 'No-ARC' barrier (like Shuttle for food and K.Ride for taxis) and never, ever sit in the pink or purple priority seats on the subway, even if the car is empty."
  ]}
  readTime={15}
...
<QuickFacts
  title="Korea Society at a Glance"
  facts={[
    { label: "2026 Minimum Wage", value: "₩10,320/hour (~$7.15)", icon: "💰" },
    { label: "7-Day Climate Card", value: "₩20,000 (Unlimited Transit)", icon: "🚇" },
    { label: "Single-Person Households", value: "42% of all households", icon: "🏠" }
  ]}
  columns={3}
/>
...
<Timeline
  title="Korea's Social Evolution"
  items={[
    { time: "2013", title: "Food Sanitation Act Revision", description: "Mandated 'final price display,' effectively removing the legal basis for service charges and tips", icon: "📜" },
    { time: "2023", title: "International Age Standardization", description: "South Korea officially shifted to the international age system, though birth years still dictate social standing", icon: "🎂" },
    { time: "Dec 2024", title: "Martial Law Reset", description: "A brief political crisis led to a massive surge in democratic participation and high institutional trust", icon: "⚖️" },
    { time: "2025", title: "The KakaoTalk 'Disaster'", description: "A major redesign of the national messenger sparked national backlash over privacy and 'Instagram-style' feeds", icon: "📱" },
    { time: "2026", title: "K-Pass Expansion", description: "The government launched a high-speed transit rebate system offering up to 53% cashback for residents", icon: "🚄" },
    { time: "Jul 2026", title: "AI Disinformation Bill", description: "New legislation took effect to curb fake news, sparking debates over free speech and digital safety", icon: "🤖" }
  ]}
/>
...
<ComparisonTable
  title="Transit Options for Visitors (2026)"
  headers={["Feature", "T-Money (Standard)", "Seoul Climate Card", "K-Pass (2026)"]}
  rows={[
    { feature: "Cost", option1: "₩3,000 + top-ups", option2: "₩20,000 (7-day)", option3: "₩62,000 (Flat monthly)" },
    { feature: "Best For", option1: "Short-term tourists", option2: "Intensive Seoul city travel", option3: "Long-term residents/Expats" },
    { feature: "Daily Savings", option1: "None (Pay per ride)", option2: "High (after 4+ rides/day)", option3: "Extreme (after 15 rides/month)" },
    { feature: "GTX Coverage", option1: "Yes (Pay per ride)", option2: "No (Seoul-only)", option3: "Yes (Premium version)" },
    { feature: "Requirements", option1: "None", option2: "None (Physical/Mobile)", option3: "Korean Bank Account/ARC" },
    { feature: "2026 Changes", option1: "Open-loop study starts", option2: "Added Ttareungi (bikes)", option3: "₩138,000 rebate potential" },
    { feature: "Ease of Use", option1: "Simple (Convenience stores)", option2: "Medium (Charging kiosks)", option3: "Complex (Registration required)" }
  ]}
/>

<ProsCons
  title="The Local Approach Analysis"
  pros={[
...
<StepGuide
  title="Navigating a Korean Business Dinner"
  totalTime="3-5 Hours"
  difficulty="medium"
  steps={[
    {
      title: "The Seating Power Play",
      description: "Wait for the most senior person (the boss or the eldest) to sit down first. Usually, they take the 'honor seat' furthest from the door or facing the main entrance.",
    ...
    {
      title: "The Two-Handed Pour",
      description: "Never pour your own drink! Use both hands to pour for others (right hand on the bottle, left hand supporting your right wrist) and receive drinks with both hands while slightly bowing.",
    ...
    {
      title: "Managing the Side Dishes (Banchan)",
      description: "It's the 'junior' person's job to make sure the side dishes are refilled and that the grill (if doing BBQ) is being tended to. Don't wait for the server; grab the tongs yourself.",
    ...
    },
    {
      ...
      description: "When the meal ends, say 'Jal meogeotseumnida' (I ate well) loudly enough for the host to hear. If the boss moves to a 'Second Round' (Noraebang), you're generally expected to go.",
...
<ExpertTip
  ...
  quote="In 2026, the real test of a 'local' isn't how much Korean you speak, but how much nunchi you have. If you can sense a senior's glass is getting empty or that the vibe of a group chat is turning sour before a single word is typed, you've made it. Also, learn to use the 'Silent Exit' feature on KakaoTalk—it's the ultimate modern manners."
/>
...
<InfoBox type="tip" title="Pro Tip: Cafe Etiquette">
...
<InfoBox type="warning" title="Avoid the Number 4!">
...
<FAQAccordion
  items={[
    {
      question: "Is it really okay to eat alone (Honbap) in 2026?",
      answer: "Absolutely! While BBQ is still a group activity, 'honbap' culture has exploded. Single-person households make up 42% of the population now, so most soup and noodle shops have counter seating specifically for solo diners."
    },
    {
      question: "Why do people push and shove in the subway without saying sorry?",
      answer: "Don't take it personally. In crowded cities like Seoul, minor bumps are just part of life. Locals often don't apologize for small collisions because it would involve too much verbal 'work.' Just keep moving and stay on the right side of the escalator."
    },
    {
      question: "Can I use my international Visa card on the bus?",
      answer: "Not quite yet. While the government is studying an 'open-loop' system for 2027, in 2026 you still need a physical T-money card or the Climate Card. Some newer buses are starting to reject cash entirely, so always have your card topped up."
    },
    {
      question: "What's with the 'No Tipping' rule? Is it illegal?",
      answer: "It's not illegal to give a tip, but it's illegal for a restaurant to require one under the Food Sanitation Act. Culturally, it's seen as a burden. If you really want to show thanks, a small gift like a canned coffee is much better received than cash."
    },
    {
      question: "Is KakaoTalk better than WhatsApp for Korea?",
      answer: "It's not just better; it's mandatory. Everyone from your landlord to your local government office uses it. If you don't have KakaoTalk, you basically don't exist in the Korean social ecosystem. Plus, the emoticons are way cuter."
    }
  ]}
/>
...
- [Visit Seoul Official](https://visit.seoul.kr/en/articles/seoul-korean-etiquette-cultural-guide-2025) - Data on bowing and subway etiquette
- [Korea Times](https://www.koreatimes.co.kr/southkorea/society/20250807/explainer-why-tipping-culture-remains-controversial-in-korea) - Tipping controversy and legal background
- [90 Day Korean](https://www.90daykorean.com/korean-etiquette/) - Drinking rules and social hierarchy
- [Korea JoongAng Daily](https://koreajoongangdaily.joins.com/news/2026-01-06/business/economy/Less-digital-more-deliberate-What-2026-trend-forecasts-say-about-young-Koreans/2491606) - 2026 social trends and single-person households
- [Commisceo Global](https://commisceo-global.com/support/culture-guides/south-korea-guide/) - Business etiquette and gift-giving
