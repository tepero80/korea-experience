...
<KeyTakeaways 
  points={[
    "The C-3-3 visa remains the primary legal pathway for medical procedures lasting up to 90 days, but as of January 1, 2026, it must be paired with a mandatory e-Arrival Card submitted at least 72 hours before departure",
    "South Korea reached a historic milestone in late 2025 with international patient spending surging to 2.08 trillion KRW, a 65.3% increase from 2024, driven heavily by 'souvenir-ization' trends in medical skincare",
    "Patients planning cosmetic or aesthetic procedures in 2026 should adjust their budgets to account for the full 10% VAT, as the long-standing tax refund program for these specific services officially expired on December 31, 2025"
  ]}
  readTime={15}
...
<QuickFacts
  title="Korea Medical Tourism at a Glance"
  facts={[
    { label: "C-3-3 Visa Fee", value: "$30 – $130 USD", icon: "💳" },
    { label: "e-Arrival Window", value: "72 Hours Prior", icon: "⏰" },
    { label: "2024 Patient Count", value: "1,170,000+", icon: "👥" }
  ]}
  columns={3}
/>
...
<Timeline
  title="Evolution of Korean Medical Tourism"
  items={[
    { time: "2005", title: "Early Adoption", description: "Approximately 60,000 foreign visitors entered Korea for preliminary medical purposes", icon: "🏥" },
    { time: "2009", title: "Legislative Foundation", description: "The Medical Service Act was amended to permit the official attraction of foreign patients and created the C-3-M/G-1-M visas", icon: "📜" },
    { time: "2016", title: "VAT Refund Launch", description: "The government introduced a 10% VAT refund for cosmetic procedures to bolster competitiveness in aesthetic medicine", icon: "💰" },
    { time: "2024", title: "Milestone Growth", description: "South Korea surpassed the 1 million patient mark, recording 1.17 million foreign visitors from 202 countries", icon: "🎉" },
    { time: "2025", title: "Digital Transformation", description: "The Mobile Alien Registration Card (ARC) was launched on March 21, allowing digital verification for banking and mobile services", icon: "📱" },
    { time: "2026", title: "Mandatory e-Arrival", description: "Effective January 1, the e-Arrival Card became the only method for entry declaration, replacing all paper-based forms", icon: "✈️" }
  ]}
/>
...
<ComparisonTable
  title="Medical Entry Routes Comparison (2026)"
  headers={["Feature", "K-ETA (Visa-Free)", "C-3-3 Medical Visa", "G-1-10 Treatment Visa"]}
  rows={[
    { feature: "Cost", option1: "~10,000 KRW", option2: "$30 - $130 USD", option3: "$50 - $200 USD" },
    { feature: "Maximum Stay", option1: "30 - 90 Days", option2: "90 Days", option3: "1 Year (Extendable)" },
    { feature: "Caregiver Coverage", option1: "Not Applicable", option2: "Immediate Family Only", option3: "Full Caregivers/Family" },
    { feature: "Invitation Needed", option1: "No", option2: "Required from Clinic", option3: "Required from Clinic" },
    { feature: "Best For", option1: "Lasers, Botox, Check-ups", option2: "Plastic Surgery, Dental", option3: "Oncology, Rehab, IVF" },
    { feature: "2026 Requirement", option1: "e-Arrival Card", option2: "e-Arrival + Visa", option3: "e-Arrival + Visa" },
    { feature: "Refund Eligibility", option1: "No Cosmetic VAT Refund", option2: "No Cosmetic VAT Refund", option3: "Not Applicable" }
  ]}
/>
...
<ProsCons
  title="C-3-3 Medical Visa Analysis"
  pros={[
...
<StepGuide
  ...
  steps={[
    {
      title: "Hospital Consultation and Registration",
      description: "Patients must first select a certified Korean medical institution and complete a virtual consultation to receive a preliminary treatment plan and cost estimate.",
      tip: "Always confirm that the clinic is registered to treat foreign patients on the official 'Medical Korea' portal to ensure their invitation numbers are valid."
    },
    {
      title: "Secure the Visa Issuance Number",
      description: "Once the treatment is confirmed and a deposit is often paid, the hospital will apply for a 'Confirmation of Visa Issuance' via the online HUNET system.",
      tip: "This issuance number simplifies your visit to the Korean Consulate, as much of your background check has already been completed by the hospital."
    },
    {
      title: "Complete the Mandatory e-Arrival Card",
      description: "At least 72 hours before boarding your flight, you must submit your travel details, passport information, and Korean address to the e-Arrival Card portal.",
      tip: "Keep a digital copy or screenshot of the confirmation PDF on your phone; paper forms are no longer distributed on arrival in 2026."
    },
    {
      title: "Consulate Visit and Arrival",
      description: "Visit the nearest South Korean Embassy with your issuance number, passport, and proof of funds to receive your visa sticker or electronic printout.",
      tip: "Carry a printed copy of your hospital appointment letter, as immigration officers frequently request this for medical visa holders."
    }
  ]}
/>
...
**Phase 1: Verification and Virtual Consultation**
...
**Phase 3: Digital Entry Declaration**
The most critical change for 2026 is the mandatory e-Arrival Card. All foreign visitors, regardless of visa status, must complete this form online at [e-arrivalcard.go.kr](https://e-arrivalcard.go.kr) within 72 hours of their arrival.
...
**Phase 4: Consolidation and Arrival**
Upon receiving the C-3-3 visa (either as a sticker in the passport or an electronic printout), the patient travels to Korea. At the gate, immigration officers may verify the e-Arrival Card digitally, but carrying a PDF copy is highly recommended. For those arriving for high-risk surgeries, officers may also request to see a physical copy of the hospital invitation and proof of financial solvency.

<ExpertTip
  name="Kim Ji-won"
  role="International Medical Coordinator"
  experience="15 years in Seoul"
  quote="In 2026, the success of your medical journey depends on your digital preparation. I strongly advise patients to secure their Korean eSIM before landing. Without a working data connection to access your e-Arrival confirmation and use local navigation apps, navigating the sophisticated but complex Seoul hospital system becomes unnecessarily stressful."
/>
...
<InfoBox type="tip" title="Pro Tip: K-ETA for Minor Treatments">
...
<InfoBox type="warning" title="VAT Refund Has Ended">
...
<FAQAccordion
  items={[
    {
      question: "Can I still get a tax refund on my cosmetic surgery in 2026?",
      answer: "No, the special VAT refund for cosmetic procedures expired on December 31, 2025; standard 10% VAT now applies to all aesthetic services."
    },
    {
      question: "Do I need a paper arrival card if I have a C-3-3 visa?",
      answer: "No, as of 2026, all paper arrival forms have been replaced by the mandatory electronic e-Arrival Card system."
    },
    {
      question: "Is it possible for my sister to accompany me as a caregiver?",
      answer: "The C-3-3 caregiver provision is typically limited to immediate family (spouses, children, parents); siblings may need to apply for a standard C-3-1 tourist visa."
    },
    {
      question: "What happens if my surgery recovery takes longer than 90 days?",
      answer: "You cannot easily extend a C-3-3 visa; instead, you must apply to the local immigration office for a change of status to a G-1-10 long-term treatment visa."
    },
    {
      question: "How much should I budget for a full medical check-up in 2026?",
      answer: "Basic health screening packages in Seoul currently range from $340 to $1,700 USD, depending on the complexity of the diagnostics."
    }
  ]}
/>
...
- [VisitKorea Official Portal](https://english.visitkorea.or.kr) - Details on visa types and K-ETA exemptions
- [HiKorea (Government for Foreigners)](https://www.hikorea.go.kr) - Official guidelines for C-3-3 and G-1-10 visa requirements
- [Medical Korea (KHIDI)](https://www.medicalkorea.or.kr) - Registration of medical institutions and international patient statistics
- [e-Arrival Card Portal](https://e-arrivalcard.go.kr) - Mandatory entry declaration system requirements for 2026
- [Jivaka Medical Guide](https://jivaka.kr) - 2026 changes to VAT refunds and medical tourism cost analysis
