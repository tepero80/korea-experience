...
<KeyTakeaways 
  points={[
    "Dial 119 for free ambulance services; interpretation is available",
    "Dial 1339 for hospital referrals and medical advice in English",
    "Foreigners must usually pay a deposit for ER admission without Korean insurance",
    "Medical Korea Support Center (1577-7129) helps with medical tourism disputes"
  ]}
  readTime={18}
...
<StatCard
  title="Emergency Response Stats 2026"
  variant="gradient"
  stats={[
    { value: "6-8 min", label: "Avg Ambulance Arrival", icon: "🚑" },
    { value: "98%", label: "GPS Accuracy", icon: "📍" }
  ]}
...
<QuickFacts
  title="Emergency Numbers Breakdown"
  facts={[
    { label: "Ambulance", value: "119", icon: "🚑" },
    { label: "Police", value: "112", icon: "👮" },
    { label: "Medical Info", value: "1339", icon: "ℹ️" }
  ]}
  columns={3}
/>
...
<StepGuide
  title="How to Call an Ambulance (119)"
  totalTime="2 minutes"
  difficulty="easy"
  steps={[
    { title: "Dial 119", description: "No area code needed. Works on locked phones.", tip: "Do not hang up if you hear Korean initially." },
    { title: "Request Language", description: "Say 'English' clearly and wait for the interpreter patch-in.", tip: "This takes about 20 seconds." },
    { title: "State Location", description: "Give a landmark (e.g., 'Gangnam Station Exit 4') if you don't know the address.", tip: "Send a photo of your location if using a video call." },
    { title: "Describe Symptoms", description: "Be concise: 'Bleeding', 'Unconscious', 'Chest Pain'." }
  ]}
/>
...
For more on finding reputable clinics to minimize these risks, read our guide on [best plastic surgery clinics for foreigners in Seoul](/blog/best-plastic-surgery-clinics-for-foreigners-in-seoul).
...
<ComparisonTable
  title="Who to Call: Complication vs. Emergency"
  headers={["Scenario", "Contact", "Availability", "Language Support"]}
  rows={[
    { feature: "Life Threatening", option1: "119", option2: "24/7", option3: "High (Interpreters)" },
    { feature: "Surgical Dispute", option1: "1577-7129", option2: "Weekdays 9-6", option3: "High (Specialized)" },
    { feature: "General Sickness", option1: "1339", option2: "24/7", option3: "High (Medical Advice)" }
  ]}
/>

## Medical Mediation and Legal Disputes
...
If you are concerned about general living costs during your recovery or extended stay, check our [cost of living comparison](/blog/cost-of-living-in-seoul-vs-busan-comparison-2026).

<PriceTable
  title="Estimated ER Costs for Tourists (No Insurance)"
  variant="dualism"
  items={[
    { name: "Minor Treatment", price: "₩150,000 - 300,000", tag: "budget", description: "Fluids, X-ray, Medication" },
    { name: "Major Emergency", price: "₩2,000,000+", tag: "luxury", description: "MRI, CT Scan, Overnight Stay" }
  ]}
/>
...
If it is late at night, you can find basic medical supplies (Tylenol, digestive medicine, patches) at convenience stores like CU, GS25, and 7-Eleven. For more on what you can find there, read our guide to [must-try convenience store items](/blog/best-korean-convenience-store-food-must-try-items-2026).

<LocationCard
  name="Safe Pharmacy (Example Type)"
  nameKo="공공심야약국"
  type="Pharmacy"
  address="Search 'Public Night Pharmacy' in Naver Maps"
  hours="22:00 - 01:00"
  phone="119 for nearest location"
  priceRange="$"
  rating={4.8}
  transit="Varies by location"
  highlights={["Late Night Access", "Professional Pharmacist", "Prescription Filling"]}
  tip="Look for the 'Public Night Pharmacy' logo to ensure a licensed pharmacist is on duty late."
/>
...
<Timeline
  title="Process for Using BBB Korea"
  items={[
    { time: "Step 1", title: "Dial 1588-5644", description: "Standard call rates apply.", icon: "📱" },
    { time: "Step 2", title: "Select Language", description: "Press 1 for English.", icon: "🔢" },
    { time: "Step 3", title: "Speakerphone", description: "Hand phone to doctor/nurse.", icon: "🗣️" }
  ]}
/>
...
Instead, look for specialized Dermatology Hospitals. If it is after hours, stick to the University Hospitals mentioned earlier, as they have dermatology residents on call. For preventative advice, consult our list of [best dermatology clinics in Seoul](/blog/best-dermatology-clinics-in-seoul-for-foreigners).
...
<ProsCons
  title="Transport to Hospital: Ambulance vs. Taxi"
  pros={["Ambulance (119): Medical equipment on board", "Ambulance: Cuts through traffic", "Taxi: Faster for non-critical injuries", "Taxi: Privacy"]}
  cons={["Ambulance: Will take you to nearest hospital, not choice", "Ambulance: Fees if determined non-emergency (rare)", "Taxi: Driver may refuse bleeding passenger", "Taxi: Stuck in traffic"]}
  variant="cards"
/>
...
<InfoBox type="danger" title="Warning: Insurance">
