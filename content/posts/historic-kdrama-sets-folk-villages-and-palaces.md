...
featured: false
image: "/images/historic-kdrama-sets-folk-villages-and-palaces.webp"
---
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "DIY Public Transit", price: "₩35,000", tag: "budget", description: "Bus/Subway + Entry fees + Simple Lunch" },
    { name: "Private Tour Van", price: "₩150,000", tag: "luxury", description: "Hotel pickup + Guide + Meals + Entries" }
  ]}
/>

<InfoBox type="warning" title="Seasonal Warning">
  Many of these sets are outdoors with little shade or heating. The summers in Korea (July-August) can reach 35°C (95°F) with high humidity, while winters (January-February) can drop to -10°C (14°F). The best months for "set-hopping" are April, May, October, and November.
</InfoBox>
