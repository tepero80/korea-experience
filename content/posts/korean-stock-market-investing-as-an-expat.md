---
title: "Korean stock market investing as an expat: 2026 guide"
date: 2026-01-20
...
<KeyTakeaways 
  points={[
    ...
    "Capital gains tax is generally waived for minority shareholders, but a 15.4% dividend tax applies",
    "Fintech apps like Toss and Kakao Pay offer easier access but limited English support"
  ]}
  readTime={15}
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "2,650", label: "KOSPI Range", icon: "📈" },
    { value: "0.23%", label: "Transaction Tax", icon: "💸" }
  ]}
...
<InfoBox type="warning" title="Name Mismatch Nightmare">
...
<ComparisonTable
  title="Brokerage Comparison for Expats"
  headers={["Feature", "Samsung Securities", "Mirae Asset", "Toss Securities"]}
  rows={[
    { feature: "English App Support", option1: "Partial", option2: "Partial", option3: "None (Korean Only)" },
    { feature: "Foreigner Online Signup", option1: true, option2: true, option3: true },
    { feature: "Commission Fee", option1: "0.15%", option2: "0.14%", option3: "0.015% (Promo)" }
  ]}
/>
...
<LocationCard
  name="Mirae Asset Center 1"
  nameKo="미래에셋 센터원"
  type="Brokerage HQ"
  address="26 Eulji-ro 5-gil, Suha-dong, Jung-gu, Seoul"
  hours="09:00-16:00 (Bank Hours)"
  phone="+82-2-1588-6800"
  priceRange="$$"
  rating={4.8}
  transit="Euljiro 1-ga Station, Exit 3, 200m walk"
  highlights={["Global Desk", "English Support", "VIP Lounge"]}
  tip="Arrive before 11:30 AM or after 1:30 PM to avoid the lunch rush."
/>
...
<StepGuide
  title="Opening a Stock Account via Mobile"
  totalTime="30 minutes"
  difficulty="medium"
  steps={[
    { title: "Download the App", description: "Search for 'Samsung Securities mPOP' or 'Mirae Asset m.Stock' on Google Play or Apple App Store.", tip: "Ensure you are on the Korean store region if the app doesn't appear." },
...
<QuickFacts
  title="Tax Breakdown"
  facts={[
    { label: "Capital Gains", value: "0%*", icon: "📉" },
    { label: "Dividend Tax", value: "15.4%", icon: "💰" },
    { label: "Transaction Tax", value: "~0.23%", icon: "🏛️" }
  ]}
  columns={3}
/>
...
<Timeline
  title="Typical Trading Day"
  items={[
    { time: "09:00", title: "Market Open", description: "High volatility, highest volume of the day.", icon: "🔔" },
    { time: "11:30 - 13:00", title: "Lunch Lull", description: "Volume drops significantly as institutions break for lunch.", icon: "🍱" },
    { time: "15:20", title: "Closing Auction", description: "Orders are collected for the final closing price determination.", icon: "⚖️" },
    { time: "15:30", title: "Market Close", description: "Final prices set.", icon: "🏁" }
  ]}
/>
...
<PriceTable
  title="Stock Price Examples (Est. 2026)"
  variant="dualism"
  items={[
    { name: "Samsung Electronics", price: "₩78,000", tag: "Blue Chip", description: "Global tech giant, stable dividends" },
    { name: "EcoPro BM", price: "₩280,000", tag: "Growth", description: "Battery materials, high volatility" }
  ]}
/>
...
<ProsCons
  ...
  pros={["Tax-free limit on dividends", "Reduced tax rate (9.9%) on excess", "Losses offset gains"]}
  cons={["3-year mandatory lock-up", "Requires proof of income", "US citizens face PFIC risks with ETFs inside ISA"]}
  variant="cards"
/>
