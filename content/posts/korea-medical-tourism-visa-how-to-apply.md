---
title: "Korea medical tourism visa how to apply and requirements 2026"
date: 2026-01-13
...
<KeyTakeaways 
  points={[
    "You cannot apply without a Certificate of Admission from a registered hospital",
    "The C-3-3 visa covers stays under 90 days; G-1-10 is for long-term treatment",
    "Minimum financial proof typically starts at $3,000 USD for short-term stays",
    "Electronic visa issuance (e-visa) takes 5-7 days, while embassy visits take 14+"
  ]}
  readTime={15}
...
For patients requiring serious medical intervention—such as cancer treatment, organ transplantation, or extensive rehabilitation—that exceeds 90 days, the G-1-10 visa is applicable. This visa is valid for **1 year** and can be renewed if the medical necessity is proven by the attending physician.
...
<ComparisonTable
  title="Medical Visa Comparison 2026"
  headers={["Feature", "C-3-3 (Short-Term)", "G-1-10 (Long-Term)"]}
  rows={[
    { feature: "Duration", option1: "Max 90 days", option2: "1 year (renewable)" },
    { feature: "Processing Time", option1: "5-7 days (Electronic)", option2: "2-4 weeks" },
    { feature: "Typical Use", option1: "Plastic Surgery, Dental", option2: "Cancer, Rehab, Major Surgery" },
    { feature: "Caregiver Allowed", option1: "Yes (C-3-9 Visa)", option2: "Yes (G-1-10 Visa)" }
  ]}
/>
...
<QuickFacts
  ...
  facts={[
    { label: "Passport", value: "6+ Months Validity", icon: "passport" },
    { label: "Photo", value: "3.5cm x 4.5cm", icon: "camera" },
    { label: "Fee", value: "$40-$90 USD", icon: "money" }
  ]}
  columns={3}
/>

If you are unsure where to even begin looking for a reputable clinic to issue these documents, you might want to read our guide on [booking medical consultations in Korea](/blog/booking-medical-consultations-in-korea-online-vs-walk-in), which explains the difference between contacting clinics directly versus using an agency.
...
<StepGuide
  ...
  difficulty="medium"
  steps={[
    { title: "Find a Registered Clinic", description: "Contact a hospital or agency registered with KHIDI. Send your photos or medical records for a remote consultation.", tip: "Check for the 'Medical Korea' certification mark." },
    { title: "Pay the Deposit", description: "Clinics usually require a 10-20% deposit of the estimated surgery cost to issue the Certificate of Admission.", tip: "Use Wise or bank transfer; credit cards can be tricky remotely." },
    { title: "Receive Electronic Documents", description: "The hospital will email you the Certificate of Admission and their Business Registration Certificate." },
    { title: "Apply at Embassy or Online", description: "If eligible for e-visa, the hospital applies for you. If not, take documents to the nearest Korean Embassy.", tip: "E-visas are faster (5-7 days)." },
    { title: "Visa Issuance", description: "Once approved, download your Visa Grant Notice. It is digital; stickers are rarely put in passports anymore." }
  ]}
/>
...
For those interested in aesthetic procedures specifically, finding the right clinic is paramount. We have a detailed breakdown of the [best plastic surgery clinics for foreigners in Seoul](/blog/best-plastic-surgery-clinics-for-foreigners-in-seoul) that are verified to handle international visa paperwork.
...
<PriceTable
  title="Estimated Administrative Costs"
  variant="dualism"
  items={[
    { name: "Direct Application", price: "$50 + Courier Fees", tag: "budget", description: "DIY approach, requires embassy visit" },
    { name: "Agency Package", price: "$0 - $500", tag: "luxury", description: "Includes translation & visa handling" }
  ]}
/>
...
<Timeline
  title="Arrival Day Timeline"
  items={[
    { time: "0 min", title: "Landing", description: "Arrive at Incheon T1 or T2", icon: "🛬" },
    { time: "45 min", title: "Immigration", description: "Present passport and Visa Grant Notice", icon: "🛂" },
    { time: "90 min", title: "Transport", description: "Board Limousine Bus or Taxi to Clinic", icon: "🚌" },
    { time: "180 min", title: "Check-in", description: "Arrive at recovery accommodation", icon: "hotel" }
  ]}
/>
...
Can you change from a Tourist Visa to a Medical Visa inside Korea?
Technically, **yes**, but it is complex. You can apply for a change of status to G-1-10 if a doctor certifies that you cannot travel due to your medical condition. However, simply "wanting to stay longer" for minor swelling is rarely accepted.
...
For more on navigating immigration hurdles, check our guide on [changing visa status while in Korea](/blog/changing-visa-status-while-in-korea).
...
<ProsCons
  title="Accommodation Options for Patients"
  pros={["Hotels: 24/7 Concierge help", "Hotels: No cleaning required", "Airbnb: Kitchen for soft food prep", "Recovery Center: Specialized care"]}
  cons={["Hotels: Expensive laundry", "Airbnb: Host may not speak English", "Airbnb: strict checkout times", "Recovery Center: Small rooms"]}
  variant="cards"
/>

For a deeper dive into where to stay, specifically weighing the pros and cons of different housing types, read [Airbnb vs recovery hotels for medical tourists](/blog/airbnb-vs-recovery-hotels-for-medical-tourists).
...
<FAQAccordion
  ...
  items={[
    { question: "Can I use a C-3-3 visa for general tourism?", answer: "Technically, yes. Once you enter, you are free to travel around Korea. However, the primary purpose must be medical. If you enter and never visit the hospital that invited you, you may be flagged for future visa applications." },
    { question: "Do I need a visa if my country has a waiver agreement?", answer: "If your country has a visa-waiver agreement with Korea (like the US, UK, Singapore), you can enter as a tourist (B-1/B-2) for medical treatment typically up to 90 days. You only strictly NEED the C-3-3 medical visa if you are from a country that requires a visa to enter Korea, or if your treatment requires specific legal protections." },
    { question: "What happens if my surgery is cancelled?", answer: "If you have already entered Korea on a C-3-3 visa and the surgery is cancelled, your visa remains valid until the expiration date on your stamp (usually 90 days). However, the hospital is required to report the cancellation to immigration, which might affect extensions." },
    { question: "Can I work remotely on a medical visa?", answer: "Technically, no. Korean immigration law prohibits working on C-3 and G-1 visas. However, checking emails and doing incidental remote work for a non-Korean employer is a grey area that is generally not policed, provided you are not earning money from a Korean source." },
    { question: "Is the deposit refundable if the visa is rejected?", answer: "This depends entirely on the clinic's policy. Most reputable clinics will refund the deposit (minus an admin fee of roughly 5-10%) if you provide official proof of visa rejection. Always clarify this policy in writing before transferring money." }
  ]}
/>
...
If you are planning your trip, don't forget to budget for your time outside the clinic. Even while recovering, you can enjoy the city. Check out our guide on [budget travel in Korea](/blog/budget-travel-korea-how-to-see-seoul-for-50-a-day-2026) to manage your expenses effectively once the medical bills are paid.

<StatCard
  title="Medical Tourism Growth"
  variant="gradient"
  stats={[
    { value: "48%", label: "Dermatology", icon: "💆‍♀️" },
    { value: "22%", label: "Plastic Surgery", icon: "🏥" }
  ]}
