...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "35%", label: "CU Stores", icon: "🏪" },
    { value: "34%", label: "GS25 Stores", icon: "🏬" }
  ]}
...
## Etiquette: How Not to Be a 'G 진상' (Nuisance)
...
<Timeline
  ...
  items={[
    { time: "Step 1", title: "Empty Liquids", description: "Pour leftover soup/drink into the liquid waste bucket." },
    { time: "Step 2", title: "Separate", description: "Remove cup sleeve and lid. Separate plastic from paper." },
    { time: "Step 3", title: "Stack", description: "Nest your paper cups to save bin space." }
  ]}
/>
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "The Hungry Student", price: "₩3,800 ($2.80)", tag: "budget", description: "Shin Ramyun Cup + Triangle Gimbap + Water" },
    { name: "The K-Drama Royal", price: "₩16,500 ($12.50)", tag: "luxury", description: "Premium Bento + Fried Chicken Leg + 4-Can Beer Bundle + Dessert" }
  ]}
/>
