...
<QuickFacts
  ...
  facts={[
    { label: "Deposit Range", value: "₩5M - ₩1B+", icon: "💰" },
    { label: "Contract Term", value: "2 Years", icon: "🗓️" },
    { label: "Agent Fee", value: "0.3% - 0.9%", icon: "🤝" }
  ]}
  columns={3}
/>
...
<ComparisonTable
  ...
  headers={["Feature", "Jeonse", "Wolse"]}
  rows={[
    { feature: "Monthly Rent", option1: "None (Free)", option2: "Yes (Monthly)" },
    { feature: "Deposit Size", option1: "Huge (50-80% of value)", option2: "Moderate to High" },
    { feature: "Utility Bills", option1: "Tenant Pays", option2: "Tenant Pays" },
    { feature: "Market Share", option1: "Declining (~40%)", option2: "Rising (~60%)" },
    { feature: "Risk Level", option1: "High (Deposit Return)", option2: "Low (Small Deposit)" }
  ]}
/>
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "₩580M", label: "Avg Seoul Apt Jeonse", icon: "🏙️" },
    { value: "-5%", label: "YoY Price Change", icon: "📉" }
  ]}
...
<InfoBox type="warning" title="The Risk of Jeonse Fraud">
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "High Deposit Strategy", price: "₩400,000 Rent", tag: "saving", description: "Deposit: ₩100,000,000" },
    { name: "Low Deposit Strategy", price: "₩900,000 Rent", tag: "flexible", description: "Deposit: ₩10,000,000" }
  ]}
/>
...
<Timeline
  ...
  items={[
    { time: "Week 1", title: "Visit Budongsan", description: "Visit local real estate agents in your target neighborhood.", icon: "buildings" },
    { time: "Week 1", title: "Viewings", description: "Inspect units. Check water pressure and mold.", icon: "👀" },
    { time: "Day 7", title: "Contract", description: "Pay 10% of the deposit to secure the unit.", icon: "✍️" },
    { time: "Day 14-30", title: "Move In", description: "Pay remaining 90% deposit on move-in day.", icon: "🚚" }
  ]}
/>
...
<StepGuide
  title="How to Protect Your Deposit (Hwak-jeong-il-ja)"
  totalTime="1 hour"
  difficulty="medium"
  steps={[
    { title: "Get the Contract", description: "Ensure the lease is signed by the legal owner shown on the registry.", tip: "Check ID against the Deunggi-bu-deung-bon." },
    { title: "Visit the Jumin Center", description: "Go to the local Community Service Center (Dong-samsu-so) for your district.", tip: "Bring your ARC and lease contract." },
    { title: "Move-In Report", description: "File a Jeon-ip-sin-go (Move-in report). This proves you live there." },
    { title: "Fixed Date Stamp", description: "Request the Hwak-jeong-il-ja stamp on your contract. This establishes your priority in line if the building is auctioned." }
  ]}
/>
...
<ProsCons
  ...
  pros={["Apartments: High security, parking, community gyms, high resale value.", "Officetels: Modern, near subway stations, usually come with appliances (fridge/washer)."]}
  cons={["Apartments: Most expensive option, often unfurnished (no A/C or fridge).", "Villas: Older buildings, lack elevators, garbage disposal issues, lower security."]}
  variant="cards"
/>
...
<LocationCard
  name="Goshiwon / Goshitel"
  nameKo="고시원"
  type="Budget Housing"
  address="Found near all major Universities"
  hours="24/7 Access"
  phone="N/A"
  priceRange="$"
  rating={3.5}
  transit="Always near subway/campus"
  highlights={["No Deposit", "All Utilities Included", "Free Rice/Kimchi"]}
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "₩800k", label: "Avg Studio Rent", icon: "🏠" },
    { value: "₩150k", label: "Avg Utilities (Summer)", icon: "⚡" }
  ]}
