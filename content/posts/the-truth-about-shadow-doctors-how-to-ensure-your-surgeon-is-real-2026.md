...
<KeyTakeaways 
  points={[
    "New 2026 laws mandate CCTV inside operating rooms for all surgeries under general anesthesia",
    "Shadow doctors are most common in 'factory' clinics performing 20+ surgeries daily",
    "You have the legal right to request surgical footage within 30 days of your procedure"
  ]}
  readTime={15}
...
The term "shadow doctor" (Dae-ri surgery) refers to a fraudulent practice where the patient consults with a "Star Doctor"—usually the head surgeon or a famous specialist—but the actual procedure is performed by someone else once the patient is under anesthesia.
...
If a clinic offers a rhinoplasty for ₩2,000,000 (approx. $1,500 USD) when the market average is ₩4,000,000 to ₩6,000,000, be extremely suspicious. Shadow doctors are often used to keep labor costs down to sustain these low prices. A board-certified specialist's time is expensive; a ghost doctor's time is cheap.

<PriceTable
  title="Price vs. Safety: Rhinoplasty Example"
  variant="dualism"
  items={[
    { name: "Factory Clinic Offer", price: "₩2.5M - ₩3M", tag: "budget", description: "High risk of shadow doctor, 30 min consultation" },
    { name: "Board-Certified Specialist", price: "₩5M - ₩8M", tag: "luxury", description: "Surgeon performs 100% of procedure, verified safety" }
  ]}
/>
...
For a deeper look at finding reputable places, read our guide on the [best plastic surgery clinics for foreigners in seoul](/blog/best-plastic-surgery-clinics-for-foreigners-in-seoul).
...
<InfoBox type="tip" title="Pro Tip: The Clause Check">
...
1.  **Pre-Surgery:** Sign the consent form to have your surgery recorded.
2.  **Post-Surgery:** If you suspect foul play, you must request to view the footage within 30 days.
3.  **Cost:** The clinic can legally charge a viewing/processing fee, typically between ₩20,000 and ₩50,000 ($15-$40 USD).
4.  **Restrictions:** You may not be allowed to copy the file to a USB drive due to privacy laws protecting the staff's faces, but you are allowed to *watch* it on their premises to verify the surgeon's identity.

<QuickFacts
  title="CCTV Law Quick Facts"
  facts={[
    { label: "Retention", value: "30 Days", icon: "📅" },
    { label: "Refusal Fine", value: "₩5 Million", icon: "💸" },
    { label: "Coverage", value: "Operating Room", icon: "📹" }
  ]}
  columns={3}
/>
...
<StepGuide
  title="How to Verify Board Certification"
  totalTime="15 minutes"
  difficulty="medium"
  steps={[
    { title: "Visit the Official Portal", description: "Go to 'prskorea.co.kr' (Korean Society of Plastic and Reconstructive Surgeons). They have an English interface.", tip: "Use the 'Search Surgeon' feature." },
    { title: "Input the Name", description: "Type the surgeon's name accurately. If no results appear, try different spellings or ask the clinic for the doctor's Korean name.", tip: "Google Translate can help verify the Hangul spelling." },
    { title: "Check the Logo", description: "In the clinic, look for the official 'KSPRS' logo plaque. Only board-certified specialists can display this specific shield emblem." },
    { title: "Cross-Reference Photos", description: "Compare the photo on the website with the person you meet. Shadow doctors are often younger and less experienced." }
  ]}
/>

If you are struggling with the language barrier or booking process, it might be worth reading about [booking medical consultations in korea online vs walk in](/blog/booking-medical-consultations-in-korea-online-vs-walk-in) to understand how to navigate these systems.
...
<ProsCons
  title="Using a Medical Agency vs. Direct Booking"
  pros={["Language support during disputes", "Can arrange CCTV viewing for you", "Often have partnerships with safety-verified clinics"]}
  cons={["Higher total cost (agency fee included)", "Risk of commission-based bias", "Less direct communication with the clinic initially"]}
  variant="cards"
/>

If you are staying for a longer recovery period, you might want to consider where you stay. The choice between [airbnb vs recovery hotels for medical tourists](/blog/airbnb-vs-recovery-hotels-for-medical-tourists) is crucial, as recovery hotels often have 24/7 nursing staff who can spot complications early.
...
<ComparisonTable
  title="Clinic Types Comparison 2026"
  headers={["Feature", "Factory Clinic", "Boutique Clinic", "University Hospital"]}
  rows={[
    { feature: "Surgeon Volume", option1: "10-20 Doctors", option2: "1-3 Doctors", option3: "Department Based" },
    { feature: "Shadow Doctor Risk", option1: "High", option2: "Low", option3: "Near Zero" },
    { feature: "Price", option1: "Low ($)", option2: "High ($$$)", option3: "Very High ($$$$)" },
    { feature: "CCTV Compliance", option1: "Strict but bureaucratic", option2: "Transparent", option3: "Strict Protocol" }
  ]}
/>
...
*   **Factory Model:** 15 rhinoplasties x ₩3M = ₩45M revenue/day. (Uses shadow doctors).
*   **Boutique Model:** 3 rhinoplasties x ₩7M = ₩21M revenue/day.
...
For those getting extensive work done, such as rhinoplasty, knowing the market rate is vital. Check our guide on [best rhinoplasty clinics gangnam 2026](/blog/best-rhinoplasty-clinics-gangnam-2026) to understand standard pricing tiers so you aren't fooled by "discount" offers.
...
1.  **The "Ghost" Recovery:** If the doctor who comes to check on you during post-op visits seems unfamiliar with the details of your surgery (e.g., "Did we use ear cartilage or rib?"), be suspicious. The surgeon who cut you should know exactly what they did.
2.  **Radically Different Results:** If you asked for a natural curve and woke up with a pinched, high "Dolly" nose that is the specific signature style of a different doctor in that clinic, a switch may have occurred.
3.  **Complications:** While complications can happen to anyone, high rates of infection or asymmetry are statistically higher in ghost surgeries due to the speed and lack of care taken by substitute doctors.
...
1.  **Secure Evidence Immediately:** Request the CCTV footage within the 30-day window. Do not wait until you return to your home country.
...
3.  **Do Not Sign Settlements:** Clinics may try to offer a refund if you sign a Non-Disclosure Agreement (NDA). If you sign this, you lose your right to report them or sue.

<LocationCard
  name="Korea Medical Dispute Mediation and Arbitration Agency"
  nameKo="한국의료분쟁조정중재원"
  type="Government Agency"
  address="Seoul City Tower 5F, 110 Huam-ro, Jung-gu, Seoul"
  hours="09:00-18:00 (Mon-Fri)"
  phone="+82-1670-2545"
  priceRange="Free Consultation"
  rating={4.8}
  transit="Seoul Station (Line 1/4), Exit 10"
  highlights={["English Support", "Legal Mediation", "Dispute Resolution"]}
  tip="Bring all medical records, receipts, and contracts when visiting."
/>
