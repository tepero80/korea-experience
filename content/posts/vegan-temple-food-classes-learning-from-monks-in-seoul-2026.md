...
featured: false
image: "/images/vegan-temple-food-classes-learning-from-monks-in-seoul-2026.webp"
---
...
<InfoBox type="info" title="The Five Pungent Vegetables">
...
<LocationCard
  name="Korean Temple Food Center"
  nameKo="Official Center"
  type="Cooking School"
  ...
  priceRange="$"
  rating={4.9}
  transit="Exit 1 from Anguk Station, 3 min walk"
  highlights={["Monk-led classes", "English interpretation available", "Seasonal recipes"]}
  tip="Classes open for booking on the 15th of the preceding month at 10 AM KST."
/>
...
<StepGuide
  ...
  difficulty="medium"
  steps={[
    { title: "Visit Official Site", description: "Go to the Korean Temple Food Center website (koreatemplefood.com). Switch language to English.", tip: "Use a desktop browser for better stability." },
    { title: "Check Schedule", description: "Classes are released on the 15th of the month prior. Identify the 'Foreigner Special' or English-supported slots." },
    { title: "Payment", description: "Payment is usually required upfront via international credit card or wire transfer." }
  ]}
/>

<ExpertTip 
  author="Ji-min Park"
  role="Seoul Culinary Guide"
  type="local"
  verified={true}
>
...
<StatCard
  title="Jingwansa Key Stats"
  variant="gradient"
  stats={[
    { value: "1011 AD", label: "Founded", icon: "bad" },
    { value: "4.8/5", label: "Visitor Rating", icon: "⭐" }
  ]}
  source="Cultural Heritage Admin 2026"
/>
...
<QuickFacts
  ...
  facts={[
    { label: "Travel Time", value: "1 Hour (One way)", icon: "🚌" },
    { label: "Group Size", value: "Max 10-15", icon: "👥" },
    { label: "Best Season", value: "Autumn (Oct)", icon: "🍁" }
  ]}
  columns={3}
/>
...
<PriceTable
  title="Class Price Comparison"
  variant="dualism"
  items={[
    { name: "Jingwansa (Full Day)", price: "₩120,000", tag: "luxury", description: "Includes garden tour & tea ceremony" },
    { name: "Center (Standard)", price: "₩30,000", tag: "budget", description: "2-hour focused cooking lesson" }
  ]}
/>
...
1.  **Deodeok (Lance Asiabell):** Often called "mountain meat" due to its fibrous texture, this root is beaten with a pestle to tenderize it, then grilled with red chili paste.
2.  **Yeon-geun (Lotus Root):** Symbolizing purity in Buddhism (as the lotus blooms from the mud), this crunchy root is braised in soy sauce or deep-fried.
3.  **Shiitake Mushrooms:** Used to create the deep umami flavor that replaces meat stocks.
...
<InfoBox type="tip" title="Pro Tip: Shopping">
...
<Timeline
  title="Typical Class Timeline"
  items={[
    { time: "00:00 - 00:20", title: "Introduction", description: "Tea drinking and explanation of the day's ingredients.", icon: "🍵" },
    { time: "00:20 - 01:00", title: "Demonstration", description: "The monk demonstrates the cooking process. No talking.", icon: "👨‍🍳" },
    { time: "01:00 - 01:40", title: "Practice", description: "Participants cook at their stations. Monks assist.", icon: "🔪" },
    { time: "01:40 - 02:00", title: "Dining", description: "Eating the creation together in silence (Baru Gongyang style).", icon: "🥣" }
  ]}
/>
...
<ComparisonTable
  ...
  headers={["Feature", "Temple Food Center", "Jingwansa Templestay", "Private Private Studio"]}
  rows={[
    { feature: "English Support", option1: true, option2: true, option3: true },
    { feature: "Authenticity", option1: "High (Academic)", option2: "Very High (Environmental)", option3: "Medium" },
    { feature: "Cost", option1: "$", option2: "$$$", option3: "$$" },
    { feature: "Duration", option1: "2-3 Hours", option2: "Half/Full Day", option3: "3 Hours" }
  ]}
/>
...
<ProsCons
  title="Pros and Cons"
  pros={["Authentic cultural insight unavailable elsewhere", "Incredibly healthy, clean eating", "Direct interaction with Buddhist philosophy"]}
  cons={["Strict booking schedules (hard to get spots)", "Language barrier can still exist in some temples", "Specific flavor profile (bland for some palates)"]}
  variant="cards"
/>
...
<FAQAccordion
  ...
  items={[
    { question: "Do I need to be vegan to attend these classes?", answer: "Absolutely not. The majority of participants are non-vegetarians interested in healthy eating, Korean culture, or culinary skills. The techniques taught, especially regarding fermentation and vegetable prep, are universally applicable." },
    { question: "Are classes available in English?", answer: "Yes, the Korean Temple Food Center offers specific English-language slots, usually on weekends. Jingwansa also has English-speaking volunteers. However, availability is limited, so checking the schedule 30 days in advance is critical." },
    { question: "Can I bring children to the class?", answer: "It depends on the venue. The Korean Temple Food Center generally requires participants to be over 14 years old due to the use of knives and heat. Some Templestay programs offer family-friendly versions where the cooking is simplified." },
    { question: "What if I have allergies?", answer: "Temple food is free of meat, fish, and dairy, making it safe for many. However, it relies heavily on soy (tofu, soybean paste) and sometimes nuts (pine nuts, peanuts). Always inform the organizers of soy or nut allergies upon booking." },
    { question: "Is it possible to just eat without cooking?", answer: "Yes! If you prefer not to cook, you can visit Balwoo Gongyang in Insa-dong. It is a Michelin-guide restaurant run by the Jogye Order serving premium temple cuisine. Reservations are essential." }
  ]}
/>
