...
<StatCard
  ...
  stats={[
    ...
    { value: "112", label: "Eligible Countries", icon: "🌏" }
  ]}
...
<InfoBox type="warning" title="Crucial Warning">
...
<StepGuide
  title="K-ETA Application Process"
  totalTime="20 minutes"
  difficulty="medium"
  steps={[
    { title: "Prepare Documents", description: "Have your valid passport, a credit card, and a facial photo ready. The photo must be under 100KB and 700x700 pixels.", tip: "Use the mobile app to auto-scan your passport page." },
...
<ExpertTip 
  author="Min-ji Park"
  role="Seoul Tourism Consultant"
  type="local"
  verified={true}
>
  "Many travelers panic about the 'Address in Korea' section. If you are staying at multiple hotels, just list the first one. Ensure you include the hotel's postal code (5 digits). If staying at an Airbnb, use the host's provided English address strictly."
</ExpertTip>
...
It is important to understand the exchange rate dynamics. As of early 2026, 10,000 KRW is roughly equivalent to **$7.50 USD** or **€6.90 EUR**. However, your bank will likely charge a foreign transaction fee, usually around 2-3%.
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "Official Government Site", price: "₩10,000", tag: "budget", description: "Direct application. No extra fees. Non-refundable." },
    { name: "Agency Service", price: "₩65,000+", tag: "luxury", description: "Includes photo resizing and manual review. High markup." }
  ]}
/>
...
<Timeline
  ...
  items={[
    ...
    { time: "72 Hours Before", title: "Hard Deadline", description: "Applying after this creates a high risk of missing your flight.", icon: "⚠️" },
    { time: "Departure Day", title: "Check Status", description: "Print the K-ETA or save the screenshot on your phone.", icon: "✈️" }
  ]}
/>
...
<InfoBox type="tip" title="Pro Tip: The K-ETA App">
...
<QuickFacts
  ...
  facts={[
    ...
    { label: "Taxi to CBD", value: "60-80 mins", icon: "🚖" },
...
<LocationCard
  ...
  priceRange="$$"
  rating={4.2}
  transit="Bus 600 to Seogwipo (80 mins)"
  highlights={["Direct Int'l Flights", "Duty Free Shopping", "Gateways to Hallasan"]}
  tip="If entering Jeju directly without K-ETA (if eligible), you cannot travel to mainland Korea (Seoul/Busan)."
/>
...
<FAQAccordion
  ...
  items={[
    { question: "I made a mistake on my K-ETA application. Can I fix it?", answer: "If you made a mistake on critical data (Passport number, Name, Birth date), you cannot fix it. You must re-apply and pay the fee again. If it is non-critical data (Address, Phone number), you can update it via the 'K-ETA Application Results' page." },
    { question: "Do infants and children need a K-ETA?", answer: "Yes. Every single traveler, regardless of age, requires their own approved K-ETA. Parents can apply on behalf of their children." },
    { question: "My application was rejected. What now?", answer: "If rejected, you cannot appeal the decision. Your only option is to apply for a standard tourist visa at the nearest Korean Embassy or Consulate. This process takes 2-4 weeks, so plan accordingly." },
    { question: "I have dual citizenship. Which passport should I use?", answer: "Use the passport of the country that is eligible for K-ETA. If both are eligible, choose the one you will present at the airport. The passport number on your K-ETA must match the physical passport you hand to the immigration officer." },
    { question: "Do I need K-ETA for a layover/transit?", answer: "If you stay in the transit area and do not pass through immigration, you do NOT need a K-ETA. If you plan to leave the airport to visit Seoul for a few hours during a layover, you MUST have a K-ETA." }
  ]}
/>
...
<ProsCons
  ...
  cons={["Non-refundable fee (₩10,000)", "Requires digital application knowledge", "Risk of rejection delays flight"]}
  variant="cards"
/>
...
<InfoBox type="success" title="Ready to Go?">
