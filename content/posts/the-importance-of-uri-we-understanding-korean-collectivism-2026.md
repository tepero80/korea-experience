---
title: "Understanding Uri We in Korean Culture 2026 Guide"
date: 2026-02-01
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "51.3M", label: "Population", icon: "👥" },
    { value: "16k/km²", label: "Seoul Density", icon: "🏙️" }
  ]}
  source="Korea National Stats 2026"
/>
...
<StepGuide
  title="How to Eat Korean BBQ Like a Local"
...
<PriceTable
  title="Dining Cost Comparison (Group vs. Solo)"
  variant="dualism"
  items={[
    { name: "Group BBQ Feast (4 people)", price: "₩140,000", tag: "luxury", description: "Includes meat, stew, alcohol, and sides." },
    { name: "Solo Set Menu", price: "₩15,000", tag: "budget", description: "Single serving meal (Honbap) at a franchise." }
  ]}
/>
...
<QuickFacts
  title="Transport Realities"
  facts={[
    { label: "Base Fare", value: "₩1,500", icon: "🚇" },
    { label: "Avg Commute", value: "50 mins", icon: "⏱️" },
    { label: "Taxi Start", value: "₩5,800", icon: "🚕" }
  ]}
  columns={3}
/>
...
<ProsCons
  ...
  pros={["Incredible hospitality once you make a connection.", "Shared meals allow you to try more dishes.", "Safety is high due to social responsibility."]}
  cons={["Solo dining can still be limited in traditional places.", "Navigating hierarchy (age/status) can be tricky.", "Feeling excluded if you don't speak the language."]}
  variant="cards"
/>
...
<ComparisonTable
  ...
  headers={["Feature", "Western Style", "Korean Uri Style"]}
  rows={[
    { feature: "Purpose", option1: "Networking/Relaxation", option2: "Team Building/Solidarity" },
    { feature: "Who Pays", option1: "Split or Senior", option2: "Highest Ranking Person" },
    { feature: "Alcohol", option1: "Optional", option2: "Central Ritual (but pressure is decreasing)" }
  ]}
/>
...
<LocationCard
  ...
  priceRange="$$"
  rating={4.6}
  transit="Gyeongbokgung Station, Exit 2, 5 min walk"
  highlights={["Ginseng Chicken Soup", "Traditional Hanok", "Shared Kimchi Pots"]}
  tip="This is the ultimate 'Uri' comfort food. The line moves fast, so don't be discouraged."
/>
...
<FAQAccordion
  title="Frequently Asked Questions About Korean Collectivism"
  items={[
