---
title: "Korean Business Etiquette 2026 Guide to Cards and Bowing"
date: 2026-01-15
excerpt: "Master Korean business culture in 2026. A comprehensive guide to bowing, business cards, and meeting protocols for international professionals."
...
Related reading: [Korean Apartment Etiquette What Neighbors Expect](/blog/korean-apartment-etiquette-what-neighbors-expect-2026).
...
<KeyTakeaways 
  points={[
    "Physical business cards remain essential in 2026 despite digital trends",
    "The 45-degree bow is reserved for high-status executives and apologies",
    "Always receive items with two hands to show proper respect"
  ]}
  readTime={15}
...
<InfoBox type="tip" title="Eye Contact Rule">
...
1.  **The 15-Degree Bow (The Casual Nod):** Used for colleagues of similar rank or when passing someone in a hallway. It is quick, lasting about 1 second.
2.  **The 30-Degree Bow (The Standard):** This is the default for business meetings. Used when meeting clients or seniors. Hold for 1-2 seconds.
3.  **The 45-Degree Bow (The Deep Bow):** Reserved for CEOs, high-ranking officials, or deep apologies. Hold for 3 full seconds.
...
<StepGuide
  title="How to Exchange Business Cards Perfectly"
  totalTime="2 minutes"
  difficulty="medium"
  steps={[
    { title: "Preparation", description: "Have your cards in a dedicated case, not your wallet. Ensure they are pristine.", tip: "Invest in a leather or metal card case." },
    { title: "The Presentation", description: "Remove a card and hold it with two hands at the top corners. Ensure the Korean side faces the recipient.", tip: "Pass the card while bowing slightly." },
    { title: "The Reception", description: "Receive their card with two hands. Study it for 5-10 seconds. Read their name and title visibly.", tip: "Do not put it away immediately." },
    { title: "Placement", description: "Place the card on the table in front of you, arranged by the seating order of the counterparts.", tip: "Never write on the card in their presence." }
  ]}
/>
...
**Cost Insight:** In 2026, high-quality business card printing in Seoul (areas like Chungmuro or Gangnam) costs approximately 35,000 KRW to 50,000 KRW ($25-$36 USD) for a set of 200 cards. Turnaround time is exceptionally fast, often within 24 hours.

<ExpertTip 
  author="Min-su Kim"
  role="Corporate Consultant, Seoul"
  type="local"
  verified={true}
>
...
<StatCard
  title="Meeting Statistics 2026"
  variant="gradient"
  stats={[
    { value: "60 min", label: "Avg Duration", icon: "⏱️" },
    { value: "10 min", label: "Arrival Buffer", icon: "🏃" }
  ]}
  source="Seoul Chamber of Commerce Data"
/>
...
<ProsCons
  ...
  pros={["Dark suits (Navy/Charcoal) portray reliability", "White shirts are the standard for formality", "Polished shoes are mandatory"]}
  cons={["Bright colors can be seen as frivolous", "Patterned ties should be subtle", "Facial hair is still frowned upon in conservative conglomerates"]}
  variant="cards"
/>
...
**Maintenance Costs:** Dry cleaning a suit in Seoul is affordable and efficient. Expect to pay around 8,000 to 12,000 KRW ($6-$9 USD) for a two-piece suit, with same-day service available in most business districts like Yeouido and Gangnam.
...
<PriceTable
  title="Gift Value Guidelines (Safe Zones)"
  variant="dualism"
  items={[
    { name: "General Staff Gift", price: "₩25,000", tag: "budget", description: "Premium cookies or tea set" },
    { name: "Executive Gift", price: "₩45,000", tag: "luxury", description: "High-end whiskey or fruit basket" }
  ]}
/>
...
<LocationCard
  name="Hanwoo Myeongga"
  nameKo="Hanwoo Myeongga"
  type="Korean BBQ"
  ...
  highlights={["Private Rooms", "A++ Beef", "English Service"]}
  tip="Book a private room at least 3 days in advance for business discussions."
/>

### Drinking Etiquette
1.  **Never pour your own drink.** Wait for someone to pour for you, and pour for them when their glass is empty.
2.  **Receive with two hands.** Hold your glass with your right hand, supporting the bottom with your left.
3.  **Turn away.** When drinking with a senior, turn your head slightly away from them as a sign of respect.

### The Cost of Entertainment
A standard business dinner involving high-quality Korean beef (Hanwoo) and alcohol will cost between 80,000 KRW and 150,000 KRW ($60-$110 USD) per person. If the night moves to a "Second Round" (pub or karaoke), budget an additional 30,000 KRW to 50,000 KRW per person.

Transportation home is efficient. In 2026, the base fare for a taxi in Seoul is approximately 5,800 KRW ($4.25 USD), with a surcharge of 20-40% typically applied between 10:00 PM and 4:00 AM.

<InfoBox type="warning" title="Declining Alcohol">
...
<ComparisonTable
  title="Communication Decoders"
  headers={["English Phrase", "Western Meaning", "Korean Business Meaning"]}
  rows={[
    { feature: "Meaning", option1: "Let's meet soon", option2: "Schedule a meeting", option3: "Polite goodbye, no plan intended" },
    { feature: "Meaning", option1: "I will try", option2: "I will make an effort", option3: "I likely cannot do it, but won't say no" },
    { feature: "Meaning", option1: "Is that okay?", option2: "Seeking approval", option3: "Checking if I have offended you" }
  ]}
/>
...
<Timeline
  title="Digital Communication Flow"
  items={[
    { time: "Day 1", title: "Meeting", description: "Exchange physical cards", icon: "🤝" },
    { time: "Day 1 (PM)", title: "Email Follow-up", description: "Formal summary sent via email", icon: "📧" },
    { time: "Day 2", title: "KakaoTalk Add", description: "Add via ID (if invited) for quicker comms", icon: "📱" }
  ]}
/>
...
<FAQAccordion
  ...
  items={[
    { question: "Do I need to bow if I am a foreigner?", answer: "Yes. While Koreans forgive foreigners for mistakes, attempting to bow shows deep respect. A 30-degree bow is a safe bet for almost all business situations." },
    { question: "Can I write on a business card to add my Korean phone number?", answer: "Avoid writing on someone else's card in front of them. However, you can write on your own card before handing it over if you need to add updated information." },
    { question: "Who pays for the business dinner?", answer: "The host (inviting party) or the senior ranking person almost always pays. Going 'Dutch' is rare in business settings. If you are the supplier visiting a client, you might offer to pay, but the senior client may insist." },
    { question: "What is the best color for a business suit in Korea?", answer: "Conservative colors are best. Navy blue and charcoal gray are the gold standards. Black is often associated with funerals, though acceptable. Avoid light gray or tan for serious initial meetings." },
