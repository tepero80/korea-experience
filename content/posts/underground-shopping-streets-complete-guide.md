---
title: "Underground shopping streets complete guide: Seoul and beyond 2026"
date: 2026-02-02
excerpt: "Discover Korea's best underground shopping streets. Save up to 70% on fashion in Goto Mall, Gangnam, and Busan with our 2026 guide to prices and locations."
...
featured: true
image: "/images/underground-shopping-streets-complete-guide.webp"
---
...
<KeyTakeaways 
  points={[
    "Goto Mall connects to Express Bus Terminal and is the largest in Seoul with over 600 stores.",
    "Most items are 'Free Size' (One Size), fitting US sizes 2-6 comfortably.",
    "Paying with cash (Korean Won) often secures a discount or waives the 10% VAT.",
    "Return policies are strict; most sales are final, especially for white clothing and sale items."
  ]}
  readTime={18}
...
<QuickFacts
  title="Goto Mall Essentials"
  facts={[
    { label: "Station", value: "Express Bus Terminal", icon: "🚇" },
    { label: "Store Count", value: "600+", icon: "hasty" },
    { label: "Best Hours", value: "11:00 AM - 4:00 PM", icon: "⏱️" }
  ]}
  columns={3}
/>
...
<LocationCard
  name="Goto Mall (Go-To Mall)"
  nameKo="고투몰 (강남터미널 지하쇼핑센터)"
  type="Shopping Mall"
  address="128-4 Banpo-dong, Seocho-gu, Seoul"
  hours="10:00-22:00 (Varies by store)"
  phone="(Check official website for contact details)"
  priceRange="$"
  rating={4.7}
  transit="Express Bus Terminal Station (Lines 3, 7, 9), Exit 8-1 or 8-2"
  highlights={["Home Decor Section", "Cheapest Basics", "Food Court at Ends"]}
  tip="Walk the entire length before buying; prices are fixed but variety differs."
/>
...
<StepGuide
  title="The Underground Shopping Strategy"
  totalTime="2 hours"
  difficulty="medium"
  steps={[
    { title: "Withdraw Cash", description: "Visit an ATM before entering. Withdraw around ₩200,000 in ₩10,000 and ₩50,000 bills. Cash gives you bargaining power.", tip: "ATMs inside the mall often have long lines." },
    { title: "Scan the Whole Line", description: "Walk down one side of the aisle first without buying. Note the prices. You will likely see the same coat in 5 stores.", tip: "Use your phone notes to track store numbers of items you like." },
    { title: "Check the Quality", description: "Feel the fabric. Check the stitching. Because prices are low, quality varies wildly. Look for 'Made in Korea' tags for better stitching than cheap imports.", tip: "Check zippers immediately." },
    { title: "The Purchase", description: "Ask 'How much is this in cash?' (Hyeongeum-euro eolmayeyo?). Pay, check the item one last time, and get your receipt if possible (though rare for cash deals)." }
  ]}
/>
...
<ProsCons
  title="Underground Malls vs. Department Stores"
  pros={["Prices are 30-50% lower", "Huge variety of trendy items", "Weather-proof shopping", "Great for cheap accessories and socks"]}
  cons={["Fitting rooms are rare or non-existent", "Sizing is limited (Free Size)", "Refunds are almost impossible", "Can be crowded and claustrophobic"]}
  variant="cards"
/>
...
<PriceTable
  title="Outfit Cost Comparison (2026)"
  variant="dualism"
  items={[
    { name: "Hongdae Street Boutique", price: "₩85,000", tag: "Street Level", description: "Includes rent premium & curation" },
    { name: "Goto Mall Underground", price: "₩38,000", tag: "Underground", description: "Same style, higher volume sales" }
  ]}
/>
...
*   **Food:** It connects to fantastic food alleys. After shopping, you can explore the famous Busan food scene. Check our [Busan Seafood Guide](/blog/busan-seafood-guide-fresh-fish-markets-and-restaurants) for post-shopping meal ideas.
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "2.5M", label: "Daily Visitors", icon: "👥" },
    { value: "40%", label: "Price Difference", icon: "📉" }
  ]}
...
If you are looking for a more traditional and sustainable Korean souvenir, you might consider renting or buying a Hanbok instead. Read our guide on [Hanbok Rental](/blog/hanbok-rental-complete-guide-styles-and-pricing) to understand the difference in fabric quality.
...
<FAQAccordion
  ...
  items={[
    { question: "Can I try clothes on in underground malls?", answer: "Generally, no. Most stores prohibit trying on light-colored tops (white, beige) to prevent makeup stains. Some stores may allow trying on jackets or pants if you wear a skirt provided by them, but don't expect Western-style fitting rooms." },
    { question: "Do underground malls accept credit cards?", answer: "Yes, by law they must. However, vendors often quote a 'cash price' and a 'card price.' The card price is typically 10% higher to cover VAT and processing fees. Cash is preferred for bargaining." },
    { question: "Are the branded items real?", answer: "Likely not. If you see a 'Supreme' or 'Gucci' shirt for ₩10,000, it is a replica or a 'style-inspired' piece. Korea has strict IP laws, but underground markets often exist in a gray area. Buy for the style, not the brand label." },
    { question: "Is it wheelchair accessible?", answer: "Partially. While the main corridors are flat and smooth, the individual stores are often cramped with narrow aisles that are difficult for wheelchairs. Accessing the underground level usually requires finding the specific elevator exits (look for the yellow elevator signs on street level)." },
    { question: "What is the best time to visit to avoid crowds?", answer: "Weekday mornings (10:30 AM - 12:00 PM) are the quietest. Avoid weekends and rush hours (5:00 PM - 7:00 PM) when commuters mix with shoppers." }
  ]}
/>

**Ready to explore more of Seoul's shopping scene?**
After conquering the underground, you might want to relax. Check out our guide to the [best coffee shops in Seoul](/blog/best-coffee-shops-in-seoul-2026) to refuel your caffeine levels. Or, if you are looking for skincare products to match your new wardrobe, read about the [complete Korean skincare routine](/blog/complete-guide-to-korean-skincare-routine-10-step-method-2026).