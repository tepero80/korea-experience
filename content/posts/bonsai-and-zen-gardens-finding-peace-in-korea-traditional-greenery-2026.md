...
<ComparisonTable
  ...
  headers={["Feature", "Korean (Bunjae/Garden)", "Japanese (Bonsai/Zen)"]}
  rows={[
    { feature: "Primary Aesthetic", option1: "Naturalism & Flow", option2: "Idealized Perfection" },
    { feature: "Human Intervention", option1: "Minimal, looks untouched", option2: "High, looks manicured" },
    { feature: "Water Features", option1: "Square ponds with round islands", option2: "Irregular ponds or gravel seas" },
    { feature: "Typical Tree Age", option1: "50-300+ Years", option2: "50-500+ Years" }
  ]}
/>
...
<LocationCard
  ...
  address="675 Nokchabunjae-ro, Hangyeong-myeon, Jeju-si"
  hours="08:30-18:00 (Nov-Mar), 08:30-19:00 (Apr-Oct)"
  phone="+82-64-772-3701"
  priceRange="$$"
  rating={4.8}
  transit="Bus 755 or 820-2 from Jeju International Airport (approx. 50 mins)"
  highlights={["2,000+ Bunjae Trees", "Black Basalt Architecture", "Healing Buffet Lunch"]}
  tip="Visit in late afternoon to see the long shadows accentuate the twisted tree trunks."
/>
...
For the purest example of a Korean traditional garden—which international visitors might equate to a "Zen" experience—you must visit the Huwon (Secret Garden) at Changdeokgung Palace. Unlike the raked gravel of a Japanese Zen garden, the Secret Garden is a masterpiece of natural landscaping.
...
<StatCard
  title="Secret Garden Metrics"
  variant="gradient"
  stats={[
    { value: "462k", label: "Square Meters", icon: "🌳" },
    { value: "26,000", label: "Trees", icon: "🌲" }
  ]}
...
<StepGuide
  title="How to Book a Bunjae Class"
  totalTime="15 minutes"
  difficulty="medium"
  steps={[
    { title: "Identify a Studio", description: "Search for 'Woomyung Bonsai Museum' or 'Space Maum' in Gwacheon/Seoul.", tip: "Use Naver Maps for accurate reviews." },
    { title: "Reservation", description: "Most masters require booking 1 week in advance via Instagram DM or KakaoTalk.", tip: "Send a message in simple English or use Papago." },
    { title: "Preparation", description: "Wear clothes you don't mind getting dusty. Classes usually provide all tools." }
  ]}
/>
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "Garden Entry Only", price: "₩5,000 - ₩15,000", tag: "budget", description: "Self-guided walk" },
    { name: "Private Bunjae Class", price: "₩120,000 - ₩250,000", tag: "luxury", description: "Includes taking the tree home" }
  ]}
/>
...
<ProsCons
  ...
  pros={["Significantly cheaper than US/EU prices", "Access to native Korean species like Korean Hornbeam", "Expert advice from local growers"]}
  cons={["Strict export quarantine laws", "Soil is generally prohibited in luggage", "Requires Phytosanitary Certificate"]}
  variant="cards"
/>
...
1.  **Soil-Free:** Trees must often be "bare-rooted" (soil washed off) and packed in sterile moss.
2.  **Inspection:** You must visit the Animal and Plant Quarantine Agency (APQA) at Incheon Airport *before* check-in.
3.  **Permits:** You need an import permit from your destination country beforehand.
...
<Timeline
  title="Legal Export Process"
  items={[
    { time: "Day 1", title: "Purchase", description: "Buy tree and request 'bare-rooting' for travel", icon: "💰" },
    { time: "Day 2", title: "Certificate", description: "Obtain Phytosanitary Certificate from regional office", icon: "📄" },
    { time: "Departure", title: "Airport Check", description: "Declare at Customs/Quarantine desk 3 hours early", icon: "✈️" }
  ]}
/>
