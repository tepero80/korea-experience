---
title: "Filler types hyaluronic acid vs calcium hydroxylapatite guide"
date: 2026-01-08
...
<KeyTakeaways 
  points={[
    ...
    "CaHA fillers (like Radiesse) stimulate natural collagen and last 12-18 months.",
    "Korean domestic HA fillers cost approximately 40-50% less than imported brands."
  ]}
  readTime={12}
...
<ProsCons
  ...
  pros={["Completely reversible with Hyaluronidase", "Immediate results with high hydration", "Wide variety of densities for different areas (lips vs. cheeks)"]}
  cons={["Shorter lifespan (6-12 months)", "Can cause Tyndall effect (bluish tint) if injected too superficially", "Requires maintenance treatments"]}
  variant="cards"
/>
...
<ComparisonTable
  title="HA vs. CaHA Filler Comparison"
  headers={["Feature", "Hyaluronic Acid (HA)", "Calcium Hydroxylapatite (CaHA)"]}
  rows={[
    { feature: "Primary Brand Examples", option1: "Juvederm, Restylane, Neuramis (KR)", option2: "Radiesse" },
    { feature: "Longevity", option1: "6 - 12 Months", option2: "12 - 24 Months" },
    { feature: "Reversibility", option1: "Yes (Hyaluronidase)", option2: "No" },
    { feature: "Collagen Stimulation", option1: "Minimal", option2: "High (Biostimulatory)" },
    { feature: "Key Texture", option1: "Gel-like, Soft", option2: "Firm, Paste-like" },
    { feature: "Avg. Price in Korea (1cc)", option1: "₩150,000 - ₩400,000", option2: "₩500,000 - ₩800,000" }
  ]}
/>

<QuickFacts
  title="Procedure Quick Stats"
  facts={[
    { label: "Downtime", value: "24-48 Hours", icon: "🛌" },
    { label: "Anesthesia", value: "Topical Cream", icon: "💊" },
    { label: "Full Effect", value: "2 Weeks", icon: "✨" }
  ]}
  columns={3}
/>
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "Domestic HA (Neuramis/Yvoire)", price: "₩130,000 ($95)", tag: "budget", description: "Per 1cc. Great value, K-FDA approved." },
    { name: "Imported HA (Juvederm)", price: "₩380,000 ($280)", tag: "luxury", description: "Per 1cc. Premium standard, Vycross tech." },
    { name: "CaHA (Radiesse)", price: "₩550,000 ($410)", tag: "specialty", description: "Per 1.5cc syringe. Long-lasting structural filler." }
  ]}
/>
...
<Timeline
  ...
  items={[
    { time: "0:00", title: "Check-in & Cleaning", description: "Passport verification and face cleansing.", icon: "📝" },
    { time: "0:15", title: "Consultation", description: "3D facial scanning and doctor discussion.", icon: "👨‍⚕️" },
    { time: "0:30", title: "Numbing", description: "Application of strong topical anesthetic cream.", icon: "🧴" },
    { time: "1:00", title: "Injection", description: "The procedure takes 15-30 mins depending on areas.", icon: "💉" },
    { time: "1:30", title: "Aftercare & Prescription", description: "Antibiotic prescription and tax refund receipt.", icon: "💊" }
  ]}
/>
...
<LocationCard
  name="Representative Clinic Area: Sinsa-dong"
  nameKo="신사동 가로수길"
  type="Medical District"
  address="Sinsa-dong, Gangnam-gu, Seoul"
  hours="10:00-19:00 (Wknds 10:00-16:00)"
  phone="+82-2-1330 (Tourist Info)"
  priceRange="$$$"
  rating={4.8}
  transit="Sinsa Station (Line 3), Exit 8"
  highlights={["English Coordinators", "Tax Refund Kiosks", "High-end Facilities"]}
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "600K+", label: "Intl Patients (2025)", icon: "🌏" },
    { value: "35%", label: "Dermatology Share", icon: "💆‍♀️" }
  ]}
...
<InfoBox type="tip" title="Communication Tip">
...
<FAQAccordion
  title="Common Questions About Fillers in Korea"
  items={[
    { question: "Is it safe to get fillers immediately after landing in Korea?", answer: "Yes, there are no medical restrictions on getting fillers after a flight. However, you might be dehydrated or puffy from travel, which can make it harder for the doctor to assess your natural baseline. It is often best to wait one day to rest and hydrate." },
    { question: "Can I mix HA and CaHA fillers?", answer: "Generally, doctors will not inject HA and CaHA into the exact same anatomical layer at the same time. However, it is common to use CaHA for the deep jawline structure and HA for the lips and fine lines in the same session. This is known as a 'Liquid Facelift'." },
    { question: "Do Korean clinics use the same brands as in the US?", answer: "Yes, major clinics stock global brands like Juvéderm (Allergan) and Restylane (Galderma). However, they also heavily promote domestic brands (Neuramis, Yvoire, Atiere) because they are high quality and significantly cheaper." },
    { question: "What happens if I have a complication back home?", answer: "This is the main risk of medical tourism. Before leaving the clinic, ask for a detailed medical report in English stating exactly what product (brand and volume) was injected and where. This information is critical for your local doctor if complications arise." },
