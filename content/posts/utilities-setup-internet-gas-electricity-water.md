---
title: "Korea Utilities Setup Internet Gas Electricity Water Guide"
date: 2026-02-03
...
<KeyTakeaways 
  points={[
    "You need an ARC (Alien Registration Card) for most post-paid utility contracts",
    "Korean internet contracts are typically 3 years; early termination fees are steep",
    "City gas powers floor heating (Ondol) and costs spike significantly in winter"
  ]}
  readTime={15}
...
<QuickFacts
  ...
  facts={[
    { label: "Avg. Internet", value: "₩35k/mo", icon: "💻" },
    { label: "Setup Time", value: "2-4 Days", icon: "⏱️" },
    { label: "Voltage", value: "220V 60Hz", icon: "⚡" }
  ]}
  columns={3}
/>
...
1.  **KT (Korea Telecom):** The largest provider with the most extensive infrastructure. Best for English support.
2.  **SK Telecom:** Known for premium mobile speeds and slight price premiums.
...
<ComparisonTable
  ...
  headers={["Feature", "3-Year Contract", "1-Year Contract", "Prepaid/Month-to-Month"]}
  rows={[
    { feature: "Monthly Cost", option1: "₩22,000 - ₩40,000", option2: "₩35,000 - ₩55,000", option3: "₩50,000+" },
    { feature: "ARC Required", option1: true, option2: true, option3: false },
    { feature: "Installation Fee", option1: "Waived (Often)", option2: "₩20,000+", option3: "₩30,000+" },
    { feature: "Hardware Rental", option1: "Included", option2: "Extra Fee", option3: "Buy Own" }
  ]}
/>
...
<StepGuide
  title="How to Set Up Home Internet"
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "₩150k", label: "Avg Winter Bill (Studio)", icon: "🔥" },
    { value: "24°C", label: "Ideal Ondol Setting", icon: "🌡️" }
  ]}
  source="Korea Energy Economics Institute 2025"
/>
...
1.  **Tier 1:** Low usage (Lowest rate)
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "Standard Usage", price: "₩30,000", tag: "average", description: "Lights, fridge, laptop, fan" },
    { name: "High AC Usage", price: "₩120,000+", tag: "warning", description: "AC running 10+ hours/day" }
  ]}
/>
...
<LocationCard
  name="Convenience Store (CU, GS25, 7-Eleven)"
  nameKo="Pyeon-ui-jeom"
  type="Retail"
  address="Every street corner in Korea"
  hours="24 Hours"
  phone="N/A"
  priceRange="$"
  rating={5.0}
  transit="Within 2 min walk anywhere"
  highlights={["Buy Trash Bags Here", "Pay Utility Bills", "Withdraw Cash"]}
...
<Timeline
  title="Move-In Utility Timeline"
  items={[
    { time: "Day 0", title: "Move In", description: "Take photos of Gas, Electric, and Water meters immediately.", icon: "📸" },
    { time: "Day 1", title: "City Gas", description: "Call provider to schedule connection (must be present).", icon: "🔥" },
    { time: "Day 2", title: "Internet", description: "Technician visits for installation (appointment needed).", icon: "💻" },
    { time: "Day 30", title: "First Bills", description: "Check mail for Giro slips and set up auto-pay.", icon: "bank" }
  ]}
/>
...
<ProsCons
  title="Using Concierge Services"
  pros={["Zero language barrier", "Handles all paperwork", "Saves time during stressful moves"]}
  cons={["Service fees apply (approx ₩50k)", "Limited control over specific contract terms"]}
  variant="cards"
/>
...
<InfoBox type="success" title="Smart Home Integration">
...
<FAQAccordion
  ...
  items={[
    { question: "Can I set up internet before I get my ARC?", answer: "Generally, no. Major providers require an ARC for postpaid contracts. However, you can rent portable WiFi eggs or prepaid SIMs at the airport for short-term use until your ARC arrives (usually 3-4 weeks)." },
    { question: "What happens if I don't pay my utility bill on time?", answer: "You will receive a reminder text. A late fee of roughly 2% is added to the next month's bill. Services are rarely cut off immediately; it usually takes 2-3 months of non-payment for disconnection." },
    { question: "Is the tap water safe to drink?", answer: "Yes, Seoul's tap water meets all WHO safety standards. However, due to the age of pipes in some buildings, most locals boil it or use a water purifier (rental purifiers are a huge industry in Korea)." },
    { question: "How do I cancel my utilities when moving out?", answer: "Call the providers 3-5 days before moving. Give them your move-out date. On the day, text them a photo of the meter. They will calculate the final amount, which you must transfer immediately to close the account." },
