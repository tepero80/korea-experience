...
<KeyTakeaways 
  points={[
    ...
    "Average street food meal costs ₩15,000 (approx $11 USD) for 3-4 items",
...
<InfoBox type="success" title="Tongin Market Coin System">
  <strong>Cost:</strong> ₩10,000 ($7.50 USD) gets you a tray and 20 brass coins.
...
<FAQAccordion
  ...
  items={[
    ...
    { question: "How much money should I budget for a food tour?", answer: "Budget ₩20,000 (approx $15 USD) per person for a very full meal including beverages. If you plan to drink alcohol (Soju/Beer) at a tent bar, budget ₩35,000." }
  ]}
/>
