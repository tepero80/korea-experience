---
title: "Korean Pension System Understanding Deductions"
date: 2026-01-18
excerpt: "Navigate Korea's pension system with this essential guide. Understand deductions, eligibility, and how it impacts your finances as an expat or traveler."
category: Living in Korea
author: Korea Experience Team
image: "/images/korean-pension-system-understanding-deductions.webp"
---
...
| :---------------- | :---------------- | :------------------------------------------- |
| Employee Share    | 4.5%              | Deducted directly from monthly salary        |
| Employer Share    | 4.5%              | Paid by employer, in addition to salary      |
| **Total**         | **9.0%**          | Based on standard monthly income (up to cap) |
...
Most foreigners holding long-term visas that permit employment are typically mandatory contributors. This includes common visa types like:
...
**Exemptions:**
Some categories of foreigners are typically exempt from mandatory NPS contributions:
...
## Navigating the Application and Withdrawal Process
...
| Country               | SSA Type (Example)                      | Departure Lump-Sum Refund Eligibility in Korea |
| :-------------------- | :-------------------------------------- | :--------------------------------------------- |
| USA                   | Totalization/Coverage & Exemption       | Yes (for US citizens)                          |
| Canada                | Totalization/Coverage & Exemption       | Yes (for Canadian citizens)                    |
| UK                    | Totalization/Coverage & Exemption       | Yes (for UK citizens)                          |
| Germany               | Totalization/Coverage & Exemption       | Yes (for German citizens)                      |
| Philippines           | Reciprocal Refund Agreement             | Yes                                            |
| Australia             | Exemption Only                          | No (Korean contributions may count in Australia) |
| Vietnam               | Exemption Only                          | No (Korean contributions may count in Vietnam)   |
| Japan                 | No SSA                                  | Yes                                            |
