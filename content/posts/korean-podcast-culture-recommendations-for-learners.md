...
featured: false
image: "/images/posts/korean-podcast-culture-recommendations-for-learners.webp"
---
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "45%", label: "YoY Listener Growth", icon: "📈" },
    { value: "1.2H", label: "Daily Listening Time", icon: "🎧" }
  ]}
...
<Timeline
  ...
  items={[
    { time: "0-5 mins", title: "First Listen", description: "Listen without pausing. Do not look at transcripts. Try to get the gist.", icon: "👂" },
    { time: "5-20 mins", title: "Vocabulary Hunt", description: "Listen again, pausing to write down unknown words. Look them up in Naver Dictionary.", icon: "📝" },
    { time: "20-40 mins", title: "Shadowing", description: "Play the audio and repeat exactly what you hear, mimicking speed and intonation.", icon: "🗣️" },
    { time: "40-60 mins", title: "Review", description: "Read the transcript (if available) while listening one final time.", icon: "📖" }
  ]}
/>
...
<QuickFacts
  ...
  facts={[
    { label: "Streaming 1hr", value: "60-90MB", icon: "📡" },
    { label: "Download 1hr", value: "50MB", icon: "💾" },
    { label: "Free Wi-Fi", value: "Seoul Metro", icon: "📶" }
  ]}
  columns={3}
/>
...
Start with 15 minutes today. Your ears—and your future Korean friends—will thank you.
