---
title: "Cold therapy vs heat therapy for recovery in Korea"
date: 2026-01-05
...
<KeyTakeaways 
  points={[
    "Heat therapy is best for chronic muscle pain and relaxation, widely available in Jjimjilbangs for under $15 USD.",
    "Cold therapy (Cryotherapy) is ideal for acute inflammation and post-surgery recovery, costing $40-80 per session.",
    "Contrast therapy (switching between hot and cold) is the preferred local method for boosting circulation."
  ]}
  readTime={12}
...
<StatCard
  title="Recovery Efficiency Stats"
  variant="gradient"
  stats={[
    { value: "50%", label: "Less Muscle Soreness with Cryo", icon: "❄️" },
    { value: "3x", label: "Circulation Boost in Sauna", icon: "🔥" }
  ]}
...
<QuickFacts
  title="Cryotherapy Specs in Seoul"
  facts={[
    { label: "Avg Cost", value: "₩65,000", icon: "💰" },
    { label: "Duration", value: "3 Mins", icon: "⏱️" },
    { label: "Min Temp", value: "-130°C", icon: "❄️" }
  ]}
  columns={3}
/>
...
<StepGuide
  title="How to Perform Naeng-On-Yok"
  totalTime="40 minutes"
  difficulty="medium"
  steps={[
    { title: "The Warm Up", description: "Shower thoroughly. Enter a warm pool (38-40°C) for 5 minutes to acclimate.", tip: "Never jump straight into the hot tub." },
    { title: "The Heat", description: "Move to the hot pool (42-44°C) or sauna for 3-5 minutes. Sweat should be forming.", tip: "Keep a cold towel on your head to prevent dizziness." },
    { title: "The Cold Plunge", description: "Exit heat, rinse sweat, and enter the cold pool (16-18°C) for 1 minute.", tip: "Focus on breathing deeply. Do not hold your breath." },
    { title: "Repeat", description: "Repeat the cycle 3 to 5 times. Always end with cold water to close pores.", tip: "Rest for 10 minutes in the common area afterwards." }
  ]}
/>
...
<PriceTable
  title="Recovery Cost Comparison"
  variant="dualism"
  items={[
    { name: "Premium Cryotherapy", price: "₩70,000", tag: "luxury", description: "Per 3-minute session in Gangnam" },
    { name: "Local Jjimjilbang", price: "₩15,000", tag: "budget", description: "12-hour access to all saunas" }
  ]}
/>

<ComparisonTable
  title="Service Comparison"
  headers={["Feature", "Jjimjilbang (Heat)", "Cryo Clinic (Cold)", "Hanbang (Mixed)"]}
  rows={[
    { feature: "English Support", option1: false, option2: true, option3: "Varies" },
    { feature: "Reservation Req", option1: false, option2: true, option3: true },
    { feature: "Duration", option1: "Unlimited", option2: "15 Mins", option3: "1 Hour" },
    { feature: "Insurance", option1: "No", option2: "No", option3: "Residents Only" }
  ]}
/>
...
<Timeline
  title="Ideal Recovery Timeline: The 'Seoul Survivor'"
  items={[
    { time: "Day 1 (Arrival)", title: "Light Heat", description: "Visit a Jjimjilbang near your hotel. 30 mins in warm water to reset circadian rhythm.", icon: "🛬" },
    { time: "Day 3 (Mid-Trip)", title: "Contrast Therapy", description: "After heavy walking, do the Naeng-On-Yok cycle to flush legs.", icon: "walk" },
    { time: "Day 5 (Post-Procedure)", title: "Cryotherapy", description: "If you had a skin treatment, visit a Cryo clinic to reduce redness.", icon: "❄️" }
  ]}
/>
...
<FAQAccordion
  ...
  items={[
    { question: "Is it safe to do cryotherapy immediately after a sauna?", answer: "Generally, yes, this is the basis of contrast therapy. However, extreme medical cryotherapy (-130°C) requires your body to be completely dry. Do not go straight from a wet sauna to a nitrogen tank. For water-based contrast baths, it is safe and encouraged." },
    { question: "Are tattoos allowed in Korean bathhouses?", answer: "Historically, tattoos were associated with gangs, but this perception is changing. In most neighborhood Jjimjilbangs, small tattoos are fine. However, large full-back or sleeve tattoos may still draw stares or, rarely, result in denial of entry at very traditional places. Use a rash guard or tape if you are concerned." },
    { question: "Can I use my travel insurance for Hanbang (Oriental Medicine) treatments?", answer: "Usually, no. Standard travel insurance covers acute emergencies. Elective wellness treatments like moxibustion or general acupuncture for fatigue are out-of-pocket expenses. However, prices are reasonable, averaging $30-$50 USD." },
    { question: "What is the 'Sheep Head' towel and is it mandatory?", answer: "The 'Yangmeori' (Sheep Head) is a towel folded to look like sheep horns. It is purely for fun and cultural experience, popularized by K-dramas. It is not mandatory, but it helps keep sweat out of your eyes inside the hot kilns." },
    { question: "How clean are the cold plunge pools?", answer: "Korean bathhouses have strict hygiene standards. Water is constantly filtered. However, you must shower thoroughly with soap before entering any communal pool. Entering without washing is considered a major breach of etiquette." }
  ]}
/>
