...
<KeyTakeaways 
  points={[
    "Online Duty-Free apps (Lotte, Shilla) offer significantly lower prices than physical airport stores due to point systems.",
    "Immediate Tax Refund limits have increased in 2026; you can get instant VAT deductions on purchases up to ₩700,000 at participating stores.",
    "You MUST have your physical passport (or a verified mobile passport app where accepted) to make any duty-free purchase.",
    "Duty-Free items purchased downtown or online cannot be taken immediately; they must be picked up at the departure gate."
  ]}
  readTime={18}
...
<ComparisonTable
  title="Duty-Free vs. Tax Refund Systems 2026"
  headers={["Feature", "Duty-Free Shops", "Tax Refund (Tax Free)"]}
  rows={[
    { feature: "What you save", option1: "Import duty, consumption tax, VAT", option2: "10% VAT only" },
    { feature: "Who can buy", option1: "Ticketed travelers leaving Korea", option2: "Foreigners staying < 6 months" },
    { feature: "When you get goods", option1: "Pickup at airport gate (unless alcohol/local brands)", option2: "Immediately upon purchase" },
    { feature: "Best for", option1: "Luxury bags, Alcohol, High-end Cosmetics", option2: "Clothing, Road-shop K-Beauty, Snacks" }
  ]}
/>
...
1.  **Inventory:** Downtown stores often have better stock of high-demand items (like specific Chanel bags or Rolex models) than the airport.
2.  **Time:** You can browse leisurely without the pressure of a looming flight boarding time.
3.  **Ambience:** These are premium shopping environments with VIP lounges and concierge services.
...
<LocationCard
  ...
  nameKo="Lotte Myeonsejeom"
  type="Shopping Mall"
  address="30 Eulji-ro, Jung-gu, Seoul (Lotte Dept Store, Floors 9-12)"
  hours="09:30-20:00"
  phone="+82-2-1688-3000"
  priceRange="$$$"
  rating={4.7}
  transit="Euljiro 1-ga Station (Line 2), Exit 7 direct connection"
  highlights={["Largest cosmetic selection", "Star Avenue (K-Pop handprints)", "Exclusive luxury boutiques"]}
  tip="Visit between 10:00 AM and 11:30 AM to avoid the massive tour group crowds that arrive after lunch."
/>

### The Purchase Process Downtown
When you buy something at a downtown duty-free store, **you cannot take it with you**.
1.  Show your passport and flight ticket (e-ticket on phone is fine).
2.  Pay for the goods.
3.  Receive a "Exchange Voucher" (Bill of Lading).
4.  The store trucks your items to Incheon or Gimpo Airport.
5.  You pick up the items at the designated "Duty Free Pickup Zone" after passing immigration on your departure day.

<InfoBox type="warning" title="Exception for Local Brands">
...
<StepGuide
  title="How to Master Online Duty-Free Shopping"
  totalTime="60 days pre-flight"
  difficulty="medium"
  steps={[
    { title: "Download Apps", description: "Download 'Lotte Duty Free' and 'Shilla Duty Free' apps. Register an account using your passport details.", tip: "Do this 2 months before your trip." },
    { title: "Collect Points", description: "Log in daily to click 'Collect Points' buttons. In 2026, most apps give $3-$5 worth of points daily that expire at midnight.", tip: "Only collect on the day you plan to buy." },
    { title: "Input Flight Info", description: "You must input your exact flight number and date leaving Korea. If this changes, you must update the order.", tip: "Check flight number carefully." },
    { title: "Checkout Strategy", description: "Buy one batch of items at a time to maximize point usage limits per transaction.", tip: "Compare cart totals between Lotte and Shilla." },
    { title: "Airport Pickup", description: "After immigration, go to the pickup counter. You simply scan your passport, and they hand you all your bags.", tip: "Don't open the sealed 'STEB' bags until you land home." }
  ]}
/>

For those interested in K-Beauty specifically, checking out our guide on [best Korean face masks for dry sensitive skin 2026](/blog/best-korean-face-masks-for-dry-sensitive-skin-2026) can help you decide what to add to your online cart.
...
<QuickFacts
  ...
  facts={[
    { label: "Min Purchase", value: "₩15,000", icon: "🔽" },
    { label: "Max Immediate", value: "₩700,000", icon: "💳" },
    { label: "Total Cap", value: "₩6,000,000", icon: "💰" }
  ]}
  columns={3}
/>

If you are shopping in busy districts, check our guide on [best spots for solo dining in busy districts](/blog/best-spots-for-solo-dining-hon-bap-in-busy-districts-2026) to find a place to rest and organize your receipts.
...
<ProsCons
  title="Airport Shopping vs. Online/Downtown"
  pros={[
...
<StatCard
  title="Alcohol & Tobacco Duty Free Limits (Entering Korea)"
  variant="gradient"
  stats={[
    { value: "2 Bottles", label: "Alcohol (Max 2L, <$400)", icon: "🍾" },
    { value: "200", label: "Cigarettes (1 Carton)", icon: "🚬" }
  ]}
...
If you are looking for unique items beyond the big brands, consider visiting independent bookstores. Our guide on [exploring Korea independent bookstores](/blog/exploring-korea-independent-bookstores-dongne-chaekbang-2026) offers a different kind of shopping experience.
...
<FAQAccordion
  ...
  items={[
    { question: "Can I use duty-free items immediately in Korea?", answer: "No. Items purchased at 'Duty-Free' shops (Downtown or Online) are delivered to the airport gate and can only be opened after you leave the country. Items purchased at 'Tax-Free' shops (like Olive Young) can be used immediately, but consumables should technically remain sealed to qualify for the refund, though enforcement on small items is lax." },
    { question: "What happens if I forget to pick up my duty-free items at the airport?", answer: "If you board the plane without your items, the order is automatically canceled. The refund will be processed to your credit card, usually taking 2-3 weeks. However, you lose any coupons or points used." },
    { question: "Is it cheaper to buy Louis Vuitton in Korea Duty-Free or in Paris?", answer: "Generally, Paris (Eurozone) is cheaper for European luxury brands due to the VAT refund structure there. However, Korea is often cheaper than the US or China. The advantage of Korean Duty-Free is the immediate tax deduction without queuing for a refund at the airport." },
    { question: "Can I buy duty-free if I am flying to Jeju Island?", answer: "No. Flights to Jeju are domestic. However, Jeju Island has its own special duty-free allowance for domestic travelers (JDC Duty Free), but the limits are much lower ($600) and selection is limited compared to Incheon International." },
    { question: "Does the 600ml perfume limit still apply?", answer: "As of 2026, the perfume allowance for entering Korea is 60ml-100ml depending on concentration, but when leaving Korea, you can buy as much perfume as you want, provided you don't exceed your destination country's limit." }
  ]}
/>
