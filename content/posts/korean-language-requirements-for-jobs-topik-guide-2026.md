...
<KeyTakeaways 
  points={[
    ...
    "IBT (Internet-Based Testing) has expanded to 6 sessions annually in 2026",
    "Speaking scores are now mandatory for customer-facing service industry visas"
  ]}
  readTime={15}
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "480K", label: "Annual Applicants", icon: "👥" },
    { value: "55%", label: "Targeting Employment", icon: "💼" }
  ]}
  source="NIIED Official Report 2026"
/>
...
<InfoBox type="warning" title="The Writing Trap">
...
*   **Exemption:** If you have a Master’s degree or higher from a Korean university, the strict TOPIK requirement is often waived, though the language ability is still expected during the interview.
...
<PriceTable
  title="Salary Expectations by Fluency"
  variant="dualism"
  items={[
    { name: "Global MNC (English Only)", price: "₩3.5M - 5M", tag: "luxury", description: "Monthly base. High competition, limited roles." },
    { name: "Korean Corporate (TOPIK 5+)", price: "₩4M - 6.5M", tag: "standard", description: "Monthly base. Access to bonuses and promotion tracks." }
  ]}
/>
...
<QuickFacts
  title="Study Investment Required"
  facts={[
    { label: "Level 1-2", value: "200 Hours", icon: "🌱" },
    { label: "Level 3-4", value: "600 Hours", icon: "📚" },
    { label: "Level 5-6", value: "1000+ Hours", icon: "🎓" }
  ]}
  columns={3}
/>
...
<ProsCons
  title="IBT vs Paper-Based Test"
  pros={["Typing essays is 30% faster", "Results released 1 week earlier", "Headphones provide clearer audio"]}
  cons={["Cannot underline text on screen", "Limited scratch paper provided", "Eye strain from 180 min screen time"]}
  variant="cards"
/>
...
<LocationCard
  name="Kyobo Bookstore Gwanghwamun"
  nameKo="교보문고 광화문점"
  type="Bookstore"
  ...
  priceRange="$$"
  rating={4.8}
  transit="Gwanghwamun Station, Exit 4 direct connection"
  highlights={["Largest Foreign Language Section", "Dedicated TOPIK Aisle (Section G)", "Reading Tables Available"]}
  tip="Go to Section G for the 'Golden Key' (Hwang-geum-yeol-soe) series of prep books, rated highest for 2026."
/>

### Step 3: The Writing Strategy
...
<Timeline
  ...
  items={[
    { time: "09:50 AM", title: "Login", description: "Log into topik.go.kr. Have your payment plugin installed.", icon: "💻" },
    { time: "10:00 AM", title: "Refresh", description: "Registration opens. Click your desired region immediately.", icon: "🖱️" },
    { time: "10:05 AM", title: "Queue", description: "You may see '15,000 people ahead of you'. Do NOT refresh.", icon: "⏳" },
    { time: "10:20 AM", title: "Payment", description: "Select Virtual Account (Bank Transfer). It is faster than credit card processing.", icon: "💳" }
  ]}
/>

<InfoBox type="danger" title="Regional Strategy">
...
<ComparisonTable
  ...
  headers={["Feature", "University KLI", "Private Hagwon", "Online Tutor"]}
  rows={[
    { feature: "Visa Sponsorship", option1: true, option2: false, option3: false },
    { feature: "Speaking Practice", option1: "High", option2: "Medium", option3: "High" },
    { feature: "Cost per Month", option1: "₩600k+", option2: "₩450k", option3: "₩200k-400k" },
    { feature: "Exam Focus", option1: "Low", option2: "High", option3: "Custom" }
  ]}
/>
...
1.  **Arrival:** Arrive at least 40 minutes early. Doors close strictly 20 minutes before the test begins.
2.  **ID:** You MUST have your Alien Registration Card (ARC) or Passport. A photocopy is not accepted.
3.  **Electronics:** You will surrender your phone. If a hidden phone rings, you are banned for 2 years.
4.  **Tools:** For PBT, bring your own correction tape (White-out). The proctors provide a specialized felt-tip pen, but correction tape is a shared resource and waiting for it wastes precious time.
...
<StepGuide
  ...
  difficulty="easy"
  steps={[
    { title: "Wait for Date", description: "Results are usually released at 3:00 PM KST on the announced Thursday.", tip: "The site will crash. Wait until 4:00 PM." },
    { title: "Access Site", description: "Go to topik.go.kr and select 'Test Results'.", tip: "Have your test number ready." },
    { title: "Print Certificate", description: "You can print the PDF for free. Employers usually require the original PDF upload." }
  ]}
/>
...
<FAQAccordion
  ...
  items={[
    { question: "Can I work in Korea with just TOPIK Level 2?", answer: "Generally, no for professional office jobs. Level 2 is sufficient for some manufacturing visas (E-9) or manual labor, but corporate roles typically demand Level 4+. Some IT developers may get hired with lower levels if their technical skills are exceptional." },
    { question: "Does TOPIK expire?", answer: "Yes, TOPIK scores are valid for exactly two years from the result announcement date. You must retake the exam to use the score for visa renewals or new job applications after this period." },
    { question: "Is the Speaking Test mandatory for the E-7 Visa?", answer: "As of early 2026, the Speaking Test is not strictly mandatory for the basic E-7 issuance, but it is highly recommended. However, for F-2-7 point calculations, Speaking scores can now replace Writing scores in certain categories to boost your total points." },
    { question: "What is the difference between TOPIK and KIIP?", answer: "TOPIK is a proficiency test solely for checking language ability. KIIP (Korea Immigration & Integration Program) is a curriculum that includes language plus culture and law. KIIP is generally preferred for Permanent Residency (F-5) and Citizenship applications." },
