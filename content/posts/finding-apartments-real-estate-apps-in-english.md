---
title: "Finding apartments real estate apps in English in Korea"
date: 2026-01-08
...
<ProsCons
  ...
  pros={["Access to 90% of the market inventory", "Accurate, real-time pricing data", "Advanced filters for subway distance and build year"]}
  cons={["100% Korean interface requires translation", "High volume of 'bait' listings (heo-wi-mae-mul)", "Agents often speak limited English"]}
  variant="cards"
/>
...
<StepGuide
  title="Navigating Zigbang/Dabang with Translation Tools"
...
<PriceTable
  title="Monthly Cost Comparison (Seoul)"
  variant="dualism"
  items={[
    { name: "Local Officetel (Via Zigbang)", price: "₩750,000", tag: "standard", description: "+ ₩10M Deposit, 1-year contract" },
    { name: "Serviced Apartment (Via Agency)", price: "₩1,600,000", tag: "premium", description: "Low deposit, English service, 3-month min" }
  ]}
/>
...
<StatCard
  title="Seoul Rental Market 2026"
  variant="gradient"
  stats={[
    { value: "₩850k", label: "Avg. Studio Rent", icon: "💰" },
    { value: "12%", label: "YoY Price Increase", icon: "📈" }
  ]}
  source="Korea Real Estate Board Data 2026"
/>
...
<Timeline
  ...
  items={[
    { time: "Week 1", title: "Digital Scouting", description: "Use apps to identify neighborhoods and price averages. Don't contact yet.", icon: "📱" },
    { time: "Week 2", title: "Agent Visits", description: "Visit a 'Budongsan' (Real Estate Office) in your target area. Show them the app screenshots.", icon: "🤝" },
    { time: "Decision", title: "Contract Signing", description: "Pay 10% of the deposit to secure the unit. Review the Registry.", icon: "✍️" },
    { time: "Move-in", title: "Balance Payment", description: "Pay remaining deposit and first month's rent on move-in day.", icon: "🔑" }
  ]}
/>
...
1.  **Bo-jeung-geum (보증금):** Deposit / Key Money.
2.  **Wol-se (월세):** Monthly Rent.
3.  **Gwan-li-bi (관리비):** Maintenance Fee (Ask what is included: water, internet, TV?).
4.  **Pul-op-shun (풀옵션):** Full Option (Includes fridge, washer, AC, sometimes bed/desk).
5.  **Pyeong (평):** Unit of size (3.3 sq meters).

<QuickFacts
  title="Listing Essentials"
  facts={[
    { label: "Standard Deposit", value: "₩10M", icon: "💰" },
    { label: "Contract Length", value: "1-2 Years", icon: "📅" },
    { label: "Broker Fee", value: "Max 0.5%", icon: "💸" }
  ]}
  columns={3}
/>
...
1.  **Certified Copy of Register (Deung-gi-bu-deung-bon):** Before signing anything, the agent must show you this document. It proves who the real owner is and if there are any heavy mortgages on the property. If the debt on the building is more than 70% of its value, walk away.
2.  **Identity Verification:** Ensure the name on the bank account where you send the deposit matches the name on the Title Deed exactly. Never send money to an agent's personal account.
3.  **Move-in Report (Jeon-ip-sin-go):** As soon as you move in, you must register your new address at the local community center (Dong-sami-so) or Immigration office. This gives you legal protection over your deposit.
