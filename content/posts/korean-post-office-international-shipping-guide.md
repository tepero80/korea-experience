---
title: "Korean Post Office International Shipping Guide 2026"
date: 2026-01-18
...
featured: false
image: "/images/korean-post-office-international-shipping-guide.webp"
---
...
<KeyTakeaways 
  points={[
    ...
    "Surface mail is 60-70% cheaper but takes 2-3 months to arrive",
    "Standard Post Office boxes come in 6 sizes; Size 5 is best for heavy items (max 30kg)"
  ]}
  readTime={12}
...
<ComparisonTable
  ...
  rows={[
    { feature: "Speed", option1: "3-5 Days", option2: "10-14 Days", option3: "60-90 Days" },
    { feature: "Tracking", option1: "Full / Real-time", option2: "Partial", option3: "Limited" },
    { feature: "Insurance", option1: "Included (up to a limit)", option2: "Optional", option3: "Optional" },
    { feature: "Max Weight", option1: "30kg", option2: "2kg", option3: "20kg" }
  ]}
/>
...
<ExpertTip 
  ...
  verified={true}
>
If you are using Surface (Ship) mail, avoid Box Size 6. While Korea Post sells it, the postal service in the receiving country (especially the US and Australia) sometimes rejects it for being too large for standard delivery trucks, leading to return fees. Stick to Size 5 for sea shipping to be safe.
</ExpertTip>

## The "Smart" Customs Declaration System
...
<StepGuide
  title="How to Use the Korea Post Smart Service"
  totalTime="15 minutes"
  difficulty="medium"
  steps={[
    { title: "Download or Visit", description: "Go to the Korea Post Internet Post Office website (epost.go.kr) or download the app. Select 'International Mail Smart Filing'.", tip: "The site has an English language toggle at the top right." },
    { title: "Sender & Receiver Info", description: "Input your Korean address and phone number. Input the receiver's address exactly as it appears in their country." },
    { title: "Item Declaration", description: "List every item type. Be specific. Instead of 'Clothes', write 'Cotton Shirt'. You must input the quantity, weight (estimate is fine), and value in USD.", tip: "Under-declaring value to avoid taxes is illegal and can lead to seizure. Keep the total value under $800 for the USA to avoid duties." },
    { title: "Generate QR Code", description: "Once finished, save the form. You will receive a QR code or a registration number." },
    { title: "Scan at Post Office", description: "When you arrive at the counter, show the QR code. The staff will scan it and print your label instantly." }
  ]}
/>
...
<InfoBox type="danger" title="Lithium Battery Alert">
...
<PriceTable
  title="Cost Comparison: 10kg Package to Zone 3"
  variant="dualism"
  items={[
    { name: "EMS (Express)", price: "₩165,000", tag: "fastest", description: "Arrives in 4-6 days. Full tracking." },
    { name: "Surface (Sea)", price: "₩55,000", tag: "budget", description: "Arrives in 60-90 days. Basic tracking." }
  ]}
/>
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "+15%", label: "Fuel Surcharge", icon: "⛽" },
    { value: "2026", label: "Year", icon: "📅" }
  ]}
  source="Korea Post Logistics Data"
/>
...
<LocationCard
  name="Seoul Central Post Office"
  nameKo="서울중앙우체국"
  type="Post Office"
  ...
  priceRange="$"
  rating={4.8}
  transit="Myeongdong Station (Line 4), Exit 5"
  highlights={["English Speaking Staff", "Large Packing Area", "Philately Museum in Basement"]}
  tip="Avoid lunch hours (12:00-13:00) when office workers crowd the branch."
/>
...
<Timeline
  title="Shipping Journey"
  items={[
    { time: "Day 0", title: "Drop-off", description: "Package scanned at local branch", icon: "📦" },
    { time: "Day 1", title: "Incheon Logistics Center", description: "Customs scanning and x-ray", icon: "🏭" },
    { time: "Day 1-2", title: "Departure", description: "Loaded onto flight (EMS) or container (Surface)", icon: "✈️" },
    { time: "Day 3-5", title: "Destination Customs", description: "Arrival in home country and customs clearance", icon: "🛃" },
    { time: "Day 5+", title: "Local Delivery", description: "Handover to local post (e.g., USPS) for final mile", icon: "🚚" }
  ]}
/>
...
<ProsCons
  title="Korea Post vs. Private Couriers (DHL/FedEx)"
  pros={["Significantly cheaper (50% less)", "Offices are everywhere", "Easier customs process for personal items", "Free packing materials provided"]}
  cons={["Slower than DHL Express", "Stricter battery restrictions", "Weight limit often capped at 30kg", "Customer service harder to reach from abroad"]}
  variant="cards"
/>
...
"I want to send this to the USA by EMS."
**"이것을 EMS로 미국에 보내고 싶어요."** (I-geot-eul EMS-ro Mi-guk-e bo-nae-go sip-eo-yo)
</InfoBox>
