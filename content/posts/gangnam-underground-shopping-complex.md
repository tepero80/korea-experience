...
<KeyTakeaways 
  points={[
    "Located directly connected to Gangnam Station (Line 2) Exits 1-12",
    "Best for 'Free Size' trendy women's fashion costing ₩10,000-20,000",
    "Shops are open year-round, typically 10:00 AM to 10:00 PM"
  ]}
  readTime={15}
...
<StatCard
  title="Gangnam Underground Stats"
  variant="gradient"
  stats={[
    { value: "210+", label: "Active Stores", icon: "🛍️" },
    { value: "200K", label: "Daily Footfall", icon: "Walking" }
  ]}
...
<LocationCard
  ...
  hours="10:00-22:00 (Individual store times vary)"
  phone="+82-2-553-1898"
  priceRange="$"
  rating={4.4}
  transit="Gangnam Station (Line 2 & Sinbundang Line)"
  highlights={["Women's Fashion", "K-Beauty", "Accessories", "Smartphone Cases"]}
  tip="Avoid 6:00 PM - 7:30 PM on weekdays; the commuter rush is intense."
/>

### Access via Subway
1.  **From Hongdae:** Take Line 2 (Green Circle Line) towards City Hall. It takes approximately **40 minutes**.
2.  **From Myeongdong:** Take Line 4 to Dongdaemun History & Culture Park, transfer to Line 2. It takes approximately **30 minutes**.
3.  **From Jamsil (Lotte World):** Take Line 2 directly. It takes roughly **12 minutes**.
...
<InfoBox type="warning" title="Rush Hour Warning">
...
<PriceTable
  title="2026 Average Price List"
  variant="dualism"
  items={[
    { name: "Cotton T-Shirt / Blouse", price: "₩10,000", tag: "budget", description: "Standard trend item" },
    { name: "Denim Jeans", price: "₩25,000", tag: "mid-range", description: "Korean straight-leg fit" },
    { name: "Summer Dress", price: "₩19,000", tag: "budget", description: "Floral or linen styles" },
    { name: "Winter Knit Sweater", price: "₩15,000", tag: "budget", description: "Oversized fit" },
    { name: "Fashion Socks (1 pair)", price: "₩1,500", tag: "budget", description: "Made in Korea quality" }
  ]}
/>
...
For recommendations on what to buy, check our guide to [best Korean toners for every skin type 2026](/blog/best-korean-toners-for-every-skin-type-2026).
...
<StepGuide
  title="How to Get Tax Refunds in Gangnam"
  totalTime="10 minutes"
  difficulty="easy"
  steps={[
    { title: "Shop", description: "Spend at least ₩30,000 in a single transaction at a 'Tax Free' marked store.", tip: "Look for the Global Tax Free logo." },
    { title: "Passport", description: "Show your physical passport to the cashier before paying." },
    { title: "Immediate or Receipt", description: "If immediate, you pay the tax-free price. If they give you a refund receipt, keep it." },
    { title: "Kiosk", description: "Scan your passport and receipts at the refund kiosk near the Airport Railroad or major exits." }
  ]}
/>
...
**Goto Mall (Express Bus Terminal)** is the largest underground mall in Seoul (over 600 stores). It is endless, cheaper, but overwhelming and slightly older in style.
**Hongdae** is above ground, focused on street style, vintage, and indie brands. It is more expensive but offers a better "vibe" and higher quality.
**Gangnam Underground** is the perfect middle ground: convenient, trendy, and manageable in size.

<ComparisonTable
  title="Seoul Shopping Districts Comparison"
  headers={["Feature", "Gangnam Underground", "Goto Mall (Express Bus)", "Hongdae Streets"]}
  rows={[
    { feature: "Size/Scale", option1: "Medium (200+ stores)", option2: "Massive (600+ stores)", option3: "Large (District)" },
    { feature: "Price Range", option1: "Low (₩10k-30k)", option2: "Lowest (₩5k-20k)", option3: "Mid (₩20k-60k)" },
    { feature: "Fashion Style", option1: "Office & Trendy", option2: "Casual & Home", option3: "Street & Indie" },
    { feature: "Crowd", option1: "Commuters/20s-30s", option2: "Housewives/Students", option3: "Students/Tourists" },
    { feature: "Fitting Rooms", option1: "Rare", option2: "Very Rare", option3: "Common" }
  ]}
/>

If you are staying in Gangnam, visiting this mall is a no-brainer. If you are looking for specific high-end beauty treatments, check out our guide to [best Korean skin clinics in Gangnam 2026](/blog/best-korean-skin-clinics-in-gangnam-2026) which are often located right outside the station exits.
...
1.  **Paik's Coffee / Mega Coffee:** You will see people carrying massive liters of iced Americano. These budget coffee chains offer large drinks for around **₩2,000 - ₩3,500**.
2.  **Delimanju:** Follow your nose. These are custard-filled, corn-shaped cakes baked fresh. A bag of small cakes costs about **₩3,000**.
3.  **Gimbap & Tteokbokki:** Near the exits leading to the Sinbundang Line, there are small standing eateries selling spicy rice cakes and seaweed rolls for a quick energy boost.

For a more substantial meal, we recommend heading above ground. The backstreets behind Gangnam Station (specifically behind Exit 10 and 11) are packed with BBQ joints. Read our curated list of [best Korean BBQ restaurants seoul Gangnam edition 2026](/blog/best-korean-bbq-restaurants-seoul-gangnam-edition-2026) to find a spot nearby.
...
<Timeline
  title="Perfect Afternoon Itinerary"
  items={[
    { time: "14:00", title: "Arrival", description: "Arrive at Gangnam Station to avoid lunch rush", icon: "🚇" },
    { time: "14:15", title: "Underground Shopping", description: "Browse Zone 1 (Fashion) near Line 2", icon: "🛍️" },
    { time: "15:30", title: "Coffee Break", description: "Grab a cheap Mega Coffee and sit in the plaza area", icon: "☕" },
    { time: "16:00", title: "Zone 2 Shopping", description: "Check accessories and shoes near Sinbundang Line", icon: "👠" },
    { time: "17:30", title: "Dinner", description: "Exit 10 for Korean BBQ", icon: "🥩" }
  ]}
/>
...
<ProsCons
  title="Gangnam Shopping Experience"
  pros={[
...
1.  **Digital Directories:** Large touchscreens near the main rotunda help you find specific stores.
2.  **Locker Storage:** If you have luggage, use the "T-Locker" app or the physical lockers located near the restrooms. Storing a small carry-on costs about **₩2,000 for 4 hours**.
3.  **Restrooms:** The restrooms inside the station (ticketed area) are generally cleaner than the public ones in the shopping mall corridors.

If you are planning to stay in this area to maximize your shopping time, look at our recommendations for [best areas to stay near shopping districts](/blog/best-areas-to-stay-near-shopping-districts).
...
<FAQAccordion
  ...
  items={[
    { question: "Is Gangnam Underground cheaper than Dongdaemun?", answer: "generally, yes. Gangnam Underground focuses on retail at fixed low prices (₩10,000-₩20,000). Dongdaemun retail malls like Doota are more expensive, and the wholesale markets require bulk buying." },
    { question: "Can I negotiate prices here?", answer: "Rarely. Unlike traditional markets, the prices here are fixed and displayed on signs. However, if you are buying 3-4 items from one stall using cash, you might ask for a small discount (e.g., 'Discount juseyo?')." },
    { question: "Are the clothes good quality?", answer: "You get what you pay for. They are 'fast fashion' quality—good for a season or two. Check seams and zippers before buying. Socks and accessories are generally excellent quality for the price." },
    { question: "Is it wheelchair accessible?", answer: "Yes, but it can be difficult. There are elevators connecting the street to the underground, and the mall itself is flat. However, the aisles inside the stores are very narrow and crowded, making wheelchair navigation challenging inside the shops themselves." },
    { question: "Do they sell fake luxury goods?", answer: "You might see some 'inspired' items (bags or phone cases that look like luxury brands), but blatant counterfeits are less common here than in Namdaemun Market due to stricter crackdowns in the Gangnam area." }
  ]}
/>