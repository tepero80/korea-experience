...
featured: false
image: "/images/stand-up-comedy-in-seoul-english-shows.webp"
---
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "300%", label: "Audience Growth since 2020", icon: "📈" },
    { value: "40+", label: "Active English Comics", icon: "🎤" }
  ]}
...
<QuickFacts
  ...
  facts={[
    { label: "Entry Fee", value: "Free / 1 Drink", icon: "🎟️" },
    { label: "Set Length", value: "3-5 Minutes", icon: "⏱️" },
    { label: "Sign-up Time", value: "30 mins prior", icon: "📝" }
  ]}
  columns={3}
/>
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "Regular Showcase", price: "₩15,000", tag: "standard", description: "Local lineup, general seating" },
    { name: "International Headliner", price: "₩35,000", tag: "premium", description: "Touring pro, priority seating" }
  ]}
/>
...
The location of the show dictates the vibe of the evening. Because Seoul is massive—spanning over 605 square kilometers—choosing the right district matters for your logistics.
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: "Avg Beer Price", option1: "₩7,000", option2: "₩5,500", option3: "₩9,000" }
  ]}
/>
...
<Timeline
  ...
  items={[
    { time: "19:00", title: "Dinner at Linus BBQ", description: "Famous Southern BBQ in Itaewon. Approx ₩25,000/person.", icon: "🍖" },
    { time: "20:30", title: "Venue Arrival", description: "Arrive at the comedy club. Grab a front-row seat if you're brave.", icon: "🎟️" },
    { time: "21:00", title: "Showtime", description: "Enjoy 90 minutes of stand-up.", icon: "🎤" },
    { time: "23:00", title: "Post-Show Drinks", description: "Head to The Fountain or reliable pubs nearby to mingle.", icon: "🍻" }
  ]}
/>
