...
1.  **Standard Taxis (Ilban):** Typically silver, white, or orange. These are the most common and affordable.
2.  **Deluxe Taxis (Mobeom):** Black with a yellow sign on top. These drivers have 10+ years of accident-free driving. They offer more space and better service but cost significantly more.
3.  **Jumbo Taxis:** Large vans suitable for 6-9 passengers. Do not confuse these with "Call Vans," which are cargo negotiation services.
4.  **International Taxis:** Specifically designated for tourists, with drivers proficient in English, Japanese, or Chinese. These often require pre-booking.

<QuickFacts
  title="Seoul Taxi Rate Snapshot (2026 Estimates)"
  facts={[
    { label: "Base Fare", value: "₩5,800", icon: "🚕" },
    { label: "Night Surcharge", value: "20-40%", icon: "🌙" },
    { label: "Airport to City", value: "₩70k-90k", icon: "✈️" }
  ]}
  columns={3}
/>
...
<StepGuide
  title="How to Use Uber in Korea"
  totalTime="5 minutes"
  difficulty="easy"
  steps={[
...
<InfoBox type="success" title="Seamless Integration">
...
<ProsCons
  title="TADA Pros and Cons"
  pros={["Accepts international numbers and cards", "Large vans accommodate 5-6 people + luggage", "Drivers are trained not to chat unnecessarily", "Zero ride refusal policy"]}
  cons={["Higher cost (approx. 20-30% more than standard)", "Fewer vehicles available compared to Uber/UT", "Primarily available in Seoul and parts of Gyeonggi-do"]}
  variant="cards"
/>
...
<ComparisonTable
  ...
  headers={["Feature", "Uber (UT)", "TADA", "Kakao T (Tourist)"]}
  rows={[
    { feature: "Int'l Number Support", option1: true, option2: true, option3: "Limited" },
    { feature: "In-App Payment", option1: true, option2: true, option3: false },
    { feature: "English Search", option1: "Excellent", option2: "Good", option3: "Moderate" },
    { feature: "Vehicle Supply", option1: "High", option2: "Medium", option3: "Very High" }
  ]}
/>

**The Workaround:**
1.  Download Kakao T and register using your email.
2.  When asked for a phone number, select your country code. Note: verification texts sometimes fail with certain international carriers.
3.  **Crucial Step:** When requesting a ride, you **cannot** select automatic payment. You must swipe to select "General Request" (sometimes labeled "General Taxi") and choose **"Pay to Driver"**.
4.  You then pay the driver directly with your physical credit card or cash (T-Money) at the end of the ride.

<InfoBox type="warning" title="The Kakao Limitation">
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "Private Van Transfer", price: "₩110,000", tag: "luxury", description: "Meet & Greet service, no waiting" },
    { name: "Standard Taxi", price: "₩75,000", tag: "standard", description: "Metered fare + tolls, potential queue" }
  ]}
/>
...
<ExpertTip 
  author="Ji-min Kim"
  role="Seoul Hospitality Manager"
  type="local"
  verified={true}
>
...
<StepGuide
  ...
  difficulty="easy"
  steps={[
    { title: "Use Naver Map", description: "Download Naver Map (set to English). Search for your destination." },
    { title: "Find the Korean Address", description: "Click on the location name to reveal the address in Hangul (Korean characters)." },
    { title: "Show the Driver", description: "Zoom in on the Hangul address and show your phone screen to the driver. This is universally understood and much safer than trying to pronounce it." }
  ]}
/>
...
1.  **Hop in first:** If the door is unlocked, get in and then state your destination. They are less likely to kick you out.
2.  **Use Uber:** App-based rides reduce refusal rates significantly because the dispatch is tracked.
3.  **Look for "Seoul Mom-Taxi":** These represent a fleet dedicated to safety and service, though they are harder to distinguish visually without knowing the specific branding stickers.
...
<LocationCard
  ...
  priceRange="$$"
  rating={4.7}
  transit="Taxis cannot drive to the tower base."
  highlights={["Cable Car", "Panoramic Views", "Love Locks"]}
  tip="Taxis can only drop you at the Cable Car station or the parking lot. You must walk or take the bus/cable car up the final hill."
/>
...
<LocationCard
  ...
  priceRange="$$$"
  rating={4.6}
  transit="Samseong Station (Line 2)"
  highlights={["Starfield Library", "Aquarium", "Convention Center"]}
  tip="Do not just say 'COEX.' Ask for 'City Airport Terminal' or 'East Gate' to avoid being dropped far from your specific destination."
/>
...
<Timeline
  ...
  items={[
    ...
    { time: "1 Hour", title: "Call Company", description: "Have a Korean speaker (hotel staff) call the taxi company.", icon: "☎️" },
...
<FAQAccordion
  ...
  items={[
    { question: "Can I pay with cash for Uber/UT in Korea?", answer: "Generally, no. When using the Uber app to call a taxi in Korea, the payment is processed digitally through the credit card linked to your account. This is actually a benefit, as it removes the hassle of handling currency." },
    { question: "Is tipping expected in Korean taxis?", answer: "No, tipping is not a part of Korean culture. You simply pay the amount shown on the meter. If you pay with cash and tell the driver to 'keep the change' for a small amount, it is appreciated but never expected." },
    { question: "Do taxi drivers speak English?", answer: "Most standard taxi drivers have limited English proficiency. 'International Taxis' (orange with specific branding) have English-speaking drivers but are rarer. Always have your destination address ready in Korean (Hangul) on your phone." },
    { question: "What if I get scammed by a taxi driver?", answer: "If you suspect you were overcharged or the driver refused to use the meter, take a photo of the license plate and the driver ID on the dashboard. You can report this to the Korea Tourism Organization helpline by dialing 1330. They offer assistance in English." },
    { question: "Is Uber cheaper than hailing a taxi on the street?", answer: "The base rates are usually the same because Uber (UT) dispatches standard metered taxis. However, Uber may charge a small booking fee during high-demand periods. The price difference is negligible compared to the convenience it offers." }
  ]}
/>