...
<QuickFacts
  ...
  facts={[
    { label: "Base Fare", value: "₩4,800", icon: "🚕" },
    { label: "Night Surcharge", value: "20-40%", icon: "🌙" },
    { label: "Airport to City", value: "₩60k-90k", icon: "✈️" }
  ]}
  columns={3}
/>
...
<Timeline
  ...
  items={[
    ...
    { time: "1 Hour", title: "Call Company", description: "Have a Korean speaker (hotel staff) call the taxi company.", icon: "📞" },
