...
<KeyTakeaways 
  points={[
    "Strict reserved seating is mandatory for all showings, booked mostly via mobile apps",
    "Korean cinemas lead globally in premium formats like 4DX, ScreenX, and bed-style seating",
    "Snack bars feature unique items like dried squid and beer, distinct from Western candy"
  ]}
  readTime={12}
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "92%", label: "Mobile Booking", icon: "📱" },
    { value: "5 min", label: "Avg. Sellout Time", icon: "⏱️" }
  ]}
...
<ComparisonTable
  ...
  headers={["Feature", "Standard Seat", "Gold Class / Suite", "Tempur Cinema"]}
  rows={[
    { feature: "Price (Approx)", option1: "₩15,000", option2: "₩40,000", option3: "₩50,000" },
    { feature: "Recline Ability", option1: "Limited", option2: "Full Electric", option3: "Bed Mattress" },
    { feature: "Food Service", option1: "Self-serve", option2: "Table Service", option3: "Gourmet Course" },
    { feature: "Privacy", option1: "Low", option2: "High", option3: "Private Pod" }
  ]}
/>
...
<ExpertTip 
  author="Min-ji Park"
  role="Film Industry Analyst, Seoul"
  type="local"
  verified={true}
>
...
<PriceTable
  title="Concession Stand Price Comparison"
  variant="dualism"
  items={[
    { name: "CGV Combo (L Popcorn + 2 Sodas)", price: "₩11,000", tag: "budget", description: "Standard Date Set" },
    { name: "Butter Grilled Squid Body", price: "₩5,500", tag: "luxury", description: "Premium savory snack" },
    { name: "Draft Beer (Max/Cass)", price: "₩5,000", tag: "budget", description: "Alcohol allowed" },
    { name: "Hot Dog / Nacho Set", price: "₩8,000", tag: "budget", description: "Meal replacement" }
  ]}
/>
...
<StepGuide
  title="How to Identify English Audio Tickets"
  totalTime="2 minutes"
  difficulty="easy"
  steps={[
    { title: "Check the Tag", description: "Look for '자막' (Jamak) next to the movie title or time. This means Subtitles (English Audio).", tip: "Avoid '더빙' (Deobing) which means Dubbed." },
    { title: "Verify Animation", description: "If watching a cartoon, double-check. Evening showtimes are more likely to be subtitled than morning ones.", tip: "Morning shows target kids and are usually dubbed." }
  ]}
/>
...
<LocationCard
  ...
  hours="08:00-03:00 (Next Day)"
  phone="+82-1544-1122"
  priceRange="$$ - $$$"
  rating={4.8}
  transit="Connected to Yongsan Station (Line 1, Gyeongui-Jungang)"
  highlights={["IMAX Laser", "4DX Screen", "Tempur Cinema", "VR Zone"]}
  tip="This is the flagship cinema of Korea. Arrive 40 mins early to explore the themed floors and massive snack bar."
/>
...
<ProsCons
  title="Korea vs Western Cinema Experience"
  pros={[
...
<Timeline
  title="The Ultimate Seoul Movie Night Timeline"
  items={[
    { time: "D-3 Days", title: "Book Tickets", description: "Use the CGV or Lotte app to reserve prime seats (Rows G-I are usually best).", icon: "📱" },
    { time: "18:00", title: "Dinner Nearby", description: "Cinemas are usually in malls. Grab a quick meal, but save room for snacks.", icon: "🍜" },
    { time: "19:30", title: "Snack Raid", description: "Buy the 'Half & Half' popcorn and a Butter Grilled Squid body.", icon: "🍿" },
    { time: "19:50", title: "Print Ticket", description: "Use the kiosk to print your 'Photo Ticket' souvenir (optional but popular).", icon: "🎟️" },
    { time: "20:00", title: "Showtime", description: "commercials run for exactly 10 minutes past the ticket time. Movie starts at 20:10.", icon: "🎬" }
  ]}
/>
