...
<PriceTable
  title="Pharmacy Recovery Essentials Cost (2026)"
  variant="dualism"
  items={[
    { name: "Venalisa (Bruise Gel)", price: "₩12,000", tag: "budget", description: "Best for immediate bruising" },
    { name: "Noscarana (Scar Gel)", price: "₩20,000", tag: "mid-range", description: "Essential for redness/texture" },
    { name: "Dermatix Ultra", price: "₩35,000", tag: "premium", description: "Best for raised scars (keloids)" },
    { name: "Pumpkin Juice (30 packs)", price: "₩30,000", tag: "diet", description: "Internal swelling reduction" }
  ]}
/>
...
Pumpkin is rich in potassium, which helps counteract sodium retention—a major cause of prolonged swelling. In 2026, the market for "beauty pumpkin juice" has evolved. You can now find "Pure Pumpkin" (100% extract) or "Sweet Pumpkin" (mixed with apple or honey for taste).
...
For more on what to eat, check our guide to [best Korean healing foods for surgery recovery](/blog/best-korean-healing-foods-for-surgery-recovery).
...
<QuickFacts
  ...
  facts={[
    { label: "LED Cost", value: "₩50k", icon: "💡" },
    { label: "Session Time", value: "20 min", icon: "⏱️" },
    { label: "Frequency", value: "Daily", icon: "📅" }
  ]}
  columns={3}
/>
...
<StepGuide
  ...
  difficulty="medium"
  steps={[
    { title: "Cleanse", description: "Gently wash area with mild, non-exfoliating foam.", tip: "Use lukewarm water only." },
    { title: "Massage", description: "Apply Venalisa (if bruised) or Noscarana. Massage for 2 mins to break scar tissue.", tip: "Circular motions are best." },
    { title: "Protect", description: "Apply silicone sheet or high SPF sunscreen.", tip: "PA++++ is mandatory in Korea." }
  ]}
/>
...
If you are looking for accommodation that caters to this, read our comparison on [Airbnb vs recovery hotels for medical tourists](/blog/airbnb-vs-recovery-hotels-for-medical-tourists).
...
For specific product recommendations, check our [best Korean sunscreen guide](/blog/best-korean-sunscreen-guide-spf-protection-2026).
...
If you are dealing with texture issues from past acne rather than surgery, you might want to look into [acne scar treatment options in Korea](/blog/acne-scar-treatment-korea-best-options).

<ComparisonTable
  title="Recovery Aids Comparison"
  headers={["Treatment", "Cost", "Pain Level", "Best For"]}
  rows={[
    { feature: "Smartlux LED", option1: "₩50,000", option2: "None", option3: "General Swelling" },
    { feature: "Hyperbaric Oxygen", option1: "₩120,000", option2: "None", option3: "Deep Tissue Healing" },
    { feature: "Rejuran Healer", option1: "₩300,000", option2: "High", option3: "Scar Texture Repair" }
  ]}
/>
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "40%", label: "Faster Healing", icon: "⚡" },
    { value: "3.5M", label: "Medical Tourists", icon: "🏥" }
  ]}
...
*   **Abnormal:** Heat radiating from the site, pus, fever over 38°C, or sudden sharp pain after day 3.
...
<FAQAccordion
  ...
  items={[
    { question: "Can I bring Korean bruise creams back to my home country?", answer: "Yes, creams like Venalisa and Noscarana are non-prescription OTC items. You can buy them in bulk. However, ensure they are in your checked luggage if the tube size exceeds 100ml (though most are 20g)." },
    { question: "How soon can I fly after surgery regarding swelling?", answer: "Doctors usually recommend waiting 7-10 days before long-haul flights. The cabin pressure can increase swelling significantly. If you must fly, wear a compression garment and stay hydrated." },
    { question: "Is it rude to wear a mask and hat indoors in Korea?", answer: "Not at all. Even before the pandemic, wearing masks for health or after cosmetic procedures was culturally acceptable. No one will stare at you for wearing a hat and mask inside a cafe." },
    { question: "Can I drink alcohol to help with the pain?", answer: "Absolutely not. Alcohol thins the blood (increasing bruising risk) and causes inflammation (swelling). Korean clinics are extremely strict about the 'No Alcohol for 2-4 Weeks' rule." },
    { question: "Where can I find English-speaking pharmacies?", answer: "Pharmacies near major hospitals (like Asan or Samsung) or in tourist hubs like Gangnam Station and Itaewon usually have pharmacists who speak English. Look for the 'Global Pharm' sign." }
  ]}
/>
...
For more insights on the best clinics to visit, consider reading our guide to [best Korean skin clinics in Gangnam](/blog/best-korean-skin-clinics-in-gangnam-2026).

<ProsCons
  title="Korean Aftercare Approach"
  pros={["Proactive treatments speed up healing significantly", "Pharmacy products are affordable and high-quality", "Cultural acceptance of recovery gear (masks/hats)"]}
  cons={["Can be cost-intensive if treatments aren't included", "Dietary restrictions (no spicy food) can be hard for tourists", "Strict adherence to routine requires discipline"]}
  variant="cards"
/>