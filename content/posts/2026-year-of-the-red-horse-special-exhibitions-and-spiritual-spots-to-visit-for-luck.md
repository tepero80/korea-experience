...
<KeyTakeaways 
  points={[
    "The Red Horse year occurs every 60 years and represents high energy, requiring specific spiritual grounding.",
    "The National Museum of Korea's special zodiac exhibition runs through March 2026 with free admission.",
    "Jeju Island offers the most authentic equine experiences, with flights from Seoul taking just 65 minutes."
  ]}
  readTime={12}
...
<StatCard
  title="Zodiac Significance"
  variant="gradient"
  stats={[
    { value: "60 Years", label: "Cycle Duration", icon: "qh" },
    { value: "3rd", label: "Zodiac Popularity", icon: "📊" }
  ]}
...
<LocationCard
  ...
  nameKo="Guklip Jungang Bakmulgwan"
  type="Museum"
  ...
  priceRange="Free"
  rating={4.8}
  transit="Ichon Station (Line 4 & Gyeongui-Jungang), Exit 2, 400m walk"
  highlights={["Silla Earthenware", "Digital Immersive Gallery", "English Audio Guide"]}
  tip="The Special Exhibition Hall is busiest between 14:00 and 16:00."
/>
...
<StepGuide
  title="How to Enjoy a Day at LetsRun Park"
  totalTime="4-5 hours"
  difficulty="easy"
  steps={[
    { title: "Arrival", description: "Take Line 4 to Seoul Racecourse Park Station. Exit 1 leads directly to the entrance.", tip: "Arrive by 10:30 AM to avoid the betting crowds." },
    { title: "Museum Tour", description: "Visit the Equine Museum first (approx. 45 mins) to see the Red Horse exhibit." },
    { title: "Secret Garden", description: "Walk to the inner track area 'Pony Land' for a quieter picnic spot." }
  ]}
/>
...
<QuickFacts
  ...
  facts={[
    { label: "Entrance Fee", value: "4,000 KRW", icon: "🎟️" },
...
<PriceTable
  ...
  variant="dualism"
  items={[
    { name: "Premium Trail Ride", price: "₩150,000", tag: "luxury", description: "2-hour coastal trek, private guide, photos included." },
    { name: "Short Track Experience", price: "₩35,000", tag: "budget", description: "20-minute guided walk, helmet rental, carrot feeding." }
  ]}
/>

<InfoBox type="warning" title="Booking Advisory">
...
**Key Spot: The Jeju Horse Park**
Located in the Hallasan mid-mountain region, this park offers the most authentic connection to the island's history. It features a museum dedicated to the grand general who specialized in horse breeding. The park spans over 900,000 square meters of grazing land.
...
<ProsCons
  title="Souvenir Options: Traditional vs. Modern"
  pros={["Traditional Bujok support the temple directly", "Modern items are more durable for daily use", "Gold cards fit perfectly in wallets"]}
  cons={["Paper Bujok must be burned after a year", "Modern items may lack spiritual consecration", "Tourist shops often markup prices by 20%"]}
  variant="cards"
/>
...
<ComparisonTable
  ...
  rows={[
    { feature: "Cost (Seoul-East Coast)", option1: "₩120,000+", option2: "₩30,000", option3: "₩22,000" },
...
<FAQAccordion
  ...
  items={[
    { question: "What is the specific date for the start of the Red Horse Year?", answer: "The Lunar New Year falls on February 17, 2026. However, the energy of the year is celebrated throughout the entire lunar cycle." },
