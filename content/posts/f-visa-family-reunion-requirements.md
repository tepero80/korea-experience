---
title: "F Visa Family Reunion Requirements Guide for 2026"
date: 2026-01-08
excerpt: "A complete guide to South Korea F-6 and F-3 family visas. Learn income thresholds, document lists, and application steps for expats."
...
<KeyTakeaways 
  points={[
    "The 2025-2026 income requirement for a 2-person F-6 household is approx. 22.1 million KRW",
    "F-6 applicants must prove communication ability via TOPIK Level 1 or designated courses",
    "Dependent F-3 visas do not automatically grant work permission in Korea"
  ]}
  readTime={15}
  lastUpdated="2026-02-06"
/>

<InfoBox type="warning" title="Document Validity Rule">
Almost all supporting documents (proof of income, housing contracts, criminal background checks) must be issued within <strong>3 months</strong> of your application submission date. Documents older than 90 days are automatically rejected by Immigration offices.
</InfoBox>
...
<QuickFacts
  title="Visa Types at a Glance"
  facts={[
    { label: "F-6 Visa", value: "Spouse of Korean", icon: "💍" },
    { label: "F-3 Visa", value: "Expat Dependent", icon: "👨‍👩‍👧" },
    { label: "Processing", value: "3-5 Weeks", icon: "⏱️" }
  ]}
  columns={3}
/>
...
<PriceTable
  title="2026 Income Thresholds (Estimated)"
  variant="dualism"
  items={[
    { name: "2-Person Household", price: "₩22,095,000", tag: "minimum", description: "Inviter + Applicant" },
    { name: "3-Person Household", price: "₩28,290,000", tag: "standard", description: "Including one child" }
  ]}
/>
...
<StatCard
  ...
  variant="gradient"
  stats={[
    { value: "120 Hrs", label: "Min. Study Time", icon: "📚" },
    { value: "65%", label: "Pass Rate (Lvl 1)", icon: "📊" }
  ]}
  source="TOPIK Data 2025"
/>
...
*   **Average Studio Deposit:** 5,000,000 to 10,000,000 KRW in Seoul.
...
<ComparisonTable
  title="F-6 vs F-3 Privileges"
  headers={["Feature", "F-6 (Marriage)", "F-3 (Dependent)"]}
  rows={[
    { feature: "Work Permission", option1: true, option2: false },
    { feature: "Duration", option1: "1-3 Years", option2: "Matches Main Visa" },
    { feature: "Income Check", option1: "Strict", option2: "Main Visa Holder's" }
  ]}
/>

### Required Documents for F-3
1.  **Marriage/Birth Certificates:** These must be apostilled or consular verified from your home country. This is the most time-consuming step, often taking 4 to 8 weeks depending on your country of origin.
2.  **Financial Proof:** The main visa holder must show proof of employment and income (usually exceeding the GNI per capita, approx. 44 million KRW as of late 2025 data).
3.  **Tuberculosis Test:** Applicants from high-risk countries must provide a TB test result issued by a designated hospital in Korea or their home country.
...
<StepGuide
  title="How to Apply for F-Visa in Korea"
  totalTime="2-4 Weeks"
  difficulty="medium"
  steps={[
    { title: "Gather Documents", description: "Collect income tax proof, background checks, and marriage certificates. Ensure Apostilles are present.", tip: "Do this 2 months before your current visa expires." },
    { title: "Book Appointment", description: "Log into the HiKorea website to reserve a visit slot. Walk-ins are no longer accepted.", tip: "Book at least 3 weeks in advance; slots fill fast." },
    { title: "Submit & Pay", description: "Visit the office. Pay the 100,000 KRW revenue stamp fee + 30,000 KRW card fee.", tip: "Bring exact cash for the revenue stamps." },
    { title: "Waiting Period", description: "Processing takes 2 to 6 weeks. You cannot leave Korea during this time." }
  ]}
/>

<InfoBox type="danger" title="Do Not Travel">
Once you submit your application for a change of status <strong>inside Korea</strong>, do not leave the country until your new Alien Registration Card (ARC) is issued. Departing Korea cancels your application immediately.
</InfoBox>
...
<ProsCons
  title="Pros and Cons of F-1-5 (Parent Invitation)"
  pros={["Allows family unity during child-rearing", "Access to Korean healthcare (via family dependency)", "Renewable up to 3 years"]}
  cons={["Strictly no employment allowed", "Must leave once child ages out", "Requires proof of child-rearing necessity"]}
  variant="cards"
/>
...
*   **Application Fee (In Korea):** 100,000 KRW (approx. $75 USD).
*   **Registration Card Fee:** 30,000 KRW (approx. $23 USD).
*   **Medical Checkup:** 50,000 - 120,000 KRW (depending on the hospital).
*   **Translation/Notary:** 30,000 - 50,000 KRW per page.
*   **TB Test:** 20,000 - 30,000 KRW.

If you hire an administrative agent (*Haeng-jeong-sa*), expect to pay between 500,000 KRW and 1,500,000 KRW depending on the complexity of your case.

## Common Rejection Reasons to Avoid

Even with a genuine marriage, rejections happen. In 2024, approximately 15% of initial F-6 applications were rejected.

1.  **Insufficient Income Proof:** The most common reason. Ensure the Korean spouse's tax forms match the requirement exactly.
2.  **Lack of Dating Proof:** You must submit a "Statement of Circumstance" detailing how you met. If you met online or through a broker, scrutiny is higher. Include photos, chat logs (KakaoTalk/WhatsApp history exports), and call records.
3.  **Language Barrier:** Failing to prove you can speak a common language.

<LocationCard
  name="Seoul Southern Immigration Office"
  nameKo="서울남부출입국외국인사무소"
  ...
  highlights={["Visa Extension", "Status Change", "Priority Counter"]}
  tip="This is one of the busiest offices. Appointments for F-visas often book out 4 weeks in advance."
/>
...
1.  **Initial Grant:** Usually 1 year.
2.  **First Renewal:** Usually 1 year.
3.  **Subsequent Renewals:** Can be 2 or 3 years if you have children or demonstrate good income stability.

To renew, you must visit the immigration office *before* the expiration date printed on the back of your ARC. The renewal fee is 60,000 KRW.
...
*   Showing an income equal to the GNI per capita (approx. 44-45 million KRW).

<ExpertTip 
  author="Mark Thompson"
  role="F-5 Visa Holder"
  type="local"
  verified={true}
>
...
<FAQAccordion
  ...
  items={[
    { question: "Can I work on an F-3 Dependent Visa?", answer: "Not automatically. F-3 holders are strictly residents. To work, you must find an employer willing to hire you and then apply for 'Permission to Engage in Activities Outside of Visa Status.' However, high-skilled part-time work is becoming easier to approve as of 2025 regulations." },
    { question: "What happens to my F-6 visa if we get divorced?", answer: "If the divorce is ruled as the Korean spouse's fault (e.g., abuse, infidelity), you can keep your F-6 status. If it is mutual or your fault, you generally lose the visa unless you have custody of a minor child born during the marriage." },
    { question: "Does my foreign income count toward the F-6 income requirement?", answer: "Generally, no. Immigration prioritizes the Korean inviter's income. However, if the Korean spouse's income is insufficient, the foreign spouse's Korean-sourced income (past year) or significant assets (like large savings or property in Korea) can sometimes be used to bridge the gap." },
    { question: "Do I need a lawyer to apply for an F-6 visa?", answer: "No, a lawyer is not required. Many couples do it themselves. However, if you have a complicated history (previous overstay, criminal record, or previous divorce in Korea), hiring a registered Administrative Agent (Haeng-jeong-sa) is highly recommended." },
