---
title: "Korean department store rewards points and VIP guide 2026"
date: 2026-01-15
...
featured: false
image: "/images/korean-department-store-rewards-points-and-vip.webp"
---
...
<StatCard
  title="Department Store Market Share 2026"
  variant="gradient"
  stats={[
    { value: "38%", label: "Lotte", icon: "🏢" },
    { value: "31%", label: "Shinsegae", icon: "🛍️" },
    { value: "28%", label: "Hyundai", icon: "🏪" }
  ]}
...
<ComparisonTable
  title="Tourist vs. Resident Privileges"
  headers={["Feature", "Tourist (Passport)", "Resident (ARC)"]}
  rows={[
    { feature: "Instant Tax Refund", option1: true, option2: false },
    { feature: "Point Accumulation", option1: "Limited/None", option2: "Full Access" },
    { feature: "App Usage", option1: "Restricted", option2: "Full Access" },
    { feature: "VIP Lounge Access", option1: "No", option2: "Yes (with spend)" }
  ]}
/>
...
<LocationCard
  name="Lotte Department Store Main Branch"
  nameKo="롯데백화점 본점"
  type="Department Store"
  address="81 Namdaemun-ro, Jung-gu, Seoul"
  hours="10:30-20:00 (Fri-Sun 20:30)"
  phone="+82-2-771-2500"
  priceRange="$$$"
  rating={4.4}
  transit="Euljiro 1-ga Station (Line 2), Exit 7"
  highlights={["Avenuel Luxury Hall", "Duty Free Shop (9-12F)", "Basement Food Court"]}
  tip="The Duty Free shop here is separate from the Department Store. Points do not cross over easily."
/>

If you are shopping in this area, you are likely near Myeongdong. For a guide on nearby K-Beauty shopping that might not be inside the department store, check our guide on [under-the-radar K-beauty brands](/blog/best-under-the-radar-k-beauty-brands-gaining-popularity-in-2026).
...
<PriceTable
  title="Shinsegae VIP Entry Costs (Approximate)"
  variant="dualism"
  items={[
    { name: "Red Grade", price: "₩4,000,000/yr", tag: "entry", description: "Free coffee bar, parking" },
    { name: "Gold Grade", price: "₩20,000,000/yr", tag: "mid-tier", description: "Valet parking, seated lounge" }
  ]}
/>
...
For visitors planning a trip to the COEX area (where Hyundai also has a major presence), our [COEX Mall guide](/blog/coex-mall-complete-shopping-and-dining-guide) covers how to navigate the underground maze connecting the department store to the convention center.

<StepGuide
  title="How to Register for H.Point (Foreign Residents)"
  totalTime="15 minutes"
  difficulty="medium"
  steps={[
    { title: "Download App", description: "Search 'H.Point' in App Store/Play Store.", tip: "Ensure your phone language is English; the app may partially translate." },
    { title: "Select Verification", description: "Choose 'Mobile Phone Verification' (PASS app or SMS)." },
    { title: "Input Name", description: "CRITICAL: Enter your name EXACTLY as it appears on your phone bill (usually LAST FIRST). Case sensitive." },
    { title: "Link Card", description: "Once registered, a digital barcode is generated. Scan this at checkout." }
  ]}
/>
...
<InfoBox type="warning" title="Warning: Name Matching">
...
For expats comparing the cost of living and where to shop, understanding these retail premiums is essential. See our detailed breakdown of [living costs in Seoul vs Busan](/blog/cost-of-living-in-seoul-vs-busan-comparison-2026).

<Timeline
  title="The VIP Journey: A Year in Review"
  items={[
    { time: "January", title: "Status Reset", description: "VIP levels are calculated based on previous year's spend.", icon: "📅" },
    { time: "Mar-May", title: "Spring Wedding Season", description: "High spend period. Double point promotions often occur.", icon: "💍" },
    { time: "September", title: "Chuseok Gifts", description: "Buying corporate gifts sets is the fastest way to hit spending tiers.", icon: "🎁" },
    { time: "December", title: "Last Call", description: "Final month to reach spending threshold for next year's status.", icon: "🏁" }
  ]}
/>
...
<FAQAccordion
  ...
  items={[
    { question: "Can I use my friend's phone number to get their points?", answer: "Technically yes, if you just type the number at the keypad. However, to use the points or access VIP lounges, you need the app logged in on a phone, which requires identity verification." },
    { question: "Do points expire?", answer: "Yes. L.Points and Shinsegae Points generally expire 5 years after accumulation, but promotional points may expire in as little as 30 days." },
    { question: "Can I get points and a Tax Refund on the same purchase?", answer: "Generally, yes. However, the tax refund amount is calculated based on the final payment amount after points/coupons are applied." },
    { question: "Which department store is most foreigner-friendly?", answer: "The Hyundai Seoul and Shinsegae Main Branch have the most robust English signage and dedicated foreigner concierge desks." },
    { question: "Does buying a Rolex count toward VIP status?", answer: "Often, no. Some luxury boutiques (Rolex, Chanel, Hermes) and home appliance purchases may only count for 50% of the spend value or be excluded from point accumulation entirely due to low margins. Check the specific exclusions list." }
  ]}
/>
