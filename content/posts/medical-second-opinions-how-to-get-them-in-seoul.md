...
<KeyTakeaways 
  points={[
    "International patients have priority access via dedicated International Healthcare Centers (IHC)",
    "Consultations typically happen within 7-14 days, significantly faster than Western averages",
    "You must bring original pathology slides and medical imaging on a CD or USB in DICOM format"
  ]}
  readTime={15}
...
<StatCard
  title="Seoul Medical Efficiency"
  variant="gradient"
  stats={[
    { value: "93%", label: "5-Year Cancer Survival", icon: "🏥" },
    { value: "7 Days", label: "Avg. Wait Time", icon: "⏱️" }
  ]}
...
<LocationCard
  name="Samsung Medical Center IHC"
  ...
  priceRange="$$$"
  rating={4.8}
  transit="Irwon Station (Line 3), Exit 1"
  highlights={["Proton Therapy Center", "Fast-Track Int'l Service", "On-site Pharmacy"]}
  tip="Use the shuttle bus from Irwon station; the campus is quite hilly."
/>
...
<StepGuide
  title="How to Secure a Medical Second Opinion"
  totalTime="2 weeks"
  difficulty="medium"
  steps={[
    { title: "Gather Records", description: "Collect all medical records in English. Crucially, get your Radiology images (MRI/CT/X-ray) on a CD or USB in DICOM format. JPGs are not accepted for diagnosis.", tip: "Pathology slides must be physical glass slides, not just reports." },
    { title: "Contact IHC", description: "Email the International Healthcare Center of your chosen hospital. Attach your medical summary (in English). Do not walk in; appointments are mandatory for professors.", tip: "Response time is usually 24-48 hours." },
    { title: "Pre-Consultation Review", description: "The coordinator will forward your documents to the relevant specialist to confirm they can offer a meaningful second opinion. They may request more data." },
    { title: "Appointment & Visa", description: "Once confirmed, you will receive an appointment slip. If you need a Medical Visa (C-3-3), the hospital will issue an invitation letter." },
    { title: "The Consultation", description: "Arrive 30 minutes early for registration. You will meet the doctor, often with a coordinator interpreting. They will review your DICOM files on the spot." }
  ]}
/>
...
<PriceTable
  title="Estimated Costs for Second Opinions"
  variant="dualism"
  items={[
    { name: "General Consultation", price: "₩150,000", tag: "budget", description: "Standard specialist review" },
    { name: "Oncology/Complex Consult", price: "₩350,000", tag: "luxury", description: "Senior Professor + Record Review" },
    { name: "MRI (Body Part)", price: "₩800,000", tag: "average", description: "If new scans are needed" },
    { name: "Pathology Review", price: "₩200,000", tag: "essential", description: "Re-reading glass slides" }
  ]}
/>
...
**Spine and Joint Clinics:**
Korea is a world leader in spine treatments. Clinics like Wooridul Spine Hospital are globally famous. If your second opinion is regarding a herniated disc or knee replacement, a specialized clinic might offer a more focused opinion than a general university hospital.

**Ophthalmology and Plastic Surgery:**
For eye conditions or reconstructive needs, specialized clinics in Gangnam often have better equipment than general hospitals.

<ComparisonTable
  title="University Hospital vs. Specialized Clinic"
  headers={["Feature", "University Hospital (Big 5)", "Specialized Clinic"]}
  rows={[
    { feature: "Wait Time", option1: "1-2 Weeks", option2: "1-3 Days" },
    { feature: "Cost", option1: "$$$", option2: "$$" },
    { feature: "Severity", option1: "Life-threatening/Complex", option2: "Orthopedic/Specific" },
    { feature: "English Fluency", option1: "High (IHC)", option2: "Variable (Check first)" }
  ]}
/>

For those visiting specialized clinics in the Gangnam area, you can easily combine your medical trip with some local exploration. Even if you are on a tight schedule, knowing how to book appointments efficiently is key. For more on booking strategies, read our guide on [booking medical consultations in Korea](/blog/booking-medical-consultations-in-korea-online-vs-walk-in).
...
1.  **Referral Letter (Sogyunseo):** In the Korean medical system, you cannot strictly access a tertiary hospital without a referral, although international patients paying 100% out of pocket sometimes bypass this strict rule. However, a letter from your home doctor summarizing your condition is essential for the Korean doctor to understand your history.
2.  **Imaging (DICOM):** As mentioned, CDs or USBs. Cloud links (Dropbox/Google Drive) are often blocked on hospital internal networks due to security firewalls. **Bring physical media.**
3.  **Pathology Slides:** If you have cancer, bringing the actual glass slides (not just the written report) allows the Korean pathologist to re-examine the cells. This is often where "second opinions" change the diagnosis—pathology interpretation varies.
4.  **List of Current Medications:** Bring the actual bottles or a pharmacy printout. Brand names differ by country, so the chemical/generic name is required.

<InfoBox type="warning" title="Pharmacy Regulations">
...
<ProsCons
  ...
  pros={["No travel costs", "Quick turnaround", "Written English report provided"]}
  cons={["Cannot perform physical exam", "Cannot do new imaging if files are unclear", "Less personal interaction"]}
  variant="cards"
/>
...
For recovery periods, diet is essential. Korean food is generally healthy, but hospital food can be bland. Exploring local options like *Juk* (rice porridge) or *Samgyetang* (ginseng chicken soup) is highly recommended for recovering patients. Check our guide on [best Korean healing foods for surgery recovery](/blog/best-korean-healing-foods-for-surgery-recovery) for specific recommendations.

## What Happens After the Consultation?

Once the consultation is over, you will receive a diagnosis.
1.  **Agreement:** If the Korean doctor agrees with your home doctor, you have peace of mind.
2.  **Divergence:** If they disagree, they will explain *why*. Is it a different pathology interpretation? A new technology available here?
3.  **Treatment Offer:** They will provide a treatment plan with cost estimates. You are under no obligation to treat in Korea.

**Pharmacy:**
If prescribed medication, you will fill it at a pharmacy *outside* the hospital. Major hospitals have "Pharmacy Streets" right outside their gates. The pharmacists there are used to hospital prescriptions and often have simple English instructions.
...
<FAQAccordion
  ...
  items={[
    { question: "Do I need a referral letter to see a doctor in Korea?", answer: "Technically, tertiary hospitals require a referral (Sogyunseo) to process insurance. For international patients paying 100% cash, this rule is often flexible, but a medical summary from your home doctor is absolutely vital for the doctor to understand your history." },
    { question: "Can I use my National Health Insurance from my home country?", answer: "No. Foreign public insurance (like NHS or Medicare) is not accepted. You must pay out of pocket or use private international health insurance with global coverage." },
    { question: "How long does a second opinion appointment take?", answer: "The actual face-to-face time with the professor is usually 15-20 minutes. However, allow 3-4 hours for the whole process including registration, preliminary checks by fellows, and payment." },
    { question: "What if I don't speak English or Korean?", answer: "The Big 5 hospitals have coordinators for Russian, Arabic, Chinese, and Mongolian. If you speak a different language, you must hire a private medical interpreter before your visit." },
    { question: "Can I get a refund if the doctor just says the same thing as my home doctor?", answer: "No. You are paying for the professor's time and expertise to review your case. Agreement is a valid medical opinion." }
  ]}
/>
...
<InfoBox type="success" title="Emergency Numbers">
...
While you are in Seoul, try to take advantage of the safe and accessible city. Even if you are dealing with health issues, brief changes of scenery can be therapeutic. For low-impact exploration, consider visiting [accessible Seoul routes for limited mobility](/blog/accessible-seoul-best-routes-for-wheelchair-and-limited-mobility-2026).
