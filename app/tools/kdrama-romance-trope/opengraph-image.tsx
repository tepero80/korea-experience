...
export const alt = 'K-Drama Romance Trope Quiz';
...
export default async function Image() {
  return new ImageResponse(
    (
      <div
        style={{
          background: 'linear-gradient(135deg, #ec4899 0%, #d946ef 50%, #ec4899 100%)',
          width: '100%',
          height: '100%',
          display: 'flex',
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <h1 style={{ fontSize: 64, fontWeight: 800, color: 'white', lineHeight: 1.1, margin: 0, maxWidth: '1000px' }}>
            Your K-Drama Romance Trope
          </h1>
          <p style={{ fontSize: 32, color: 'rgba(255, 255, 255, 0.9)', lineHeight: 1.3, margin: 0, maxWidth: '900px' }}>
            Discover which classic Korean drama love story perfectly matches your personality!
          </p>
        </div>
