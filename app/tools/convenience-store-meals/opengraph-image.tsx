...
export const alt = 'Korean Convenience Store Meal Builder - Korea Experience';
export const size = {
  width: 1200,
  height: 630,
};
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <h1 style={{ fontSize: 64, fontWeight: 800, color: 'white', lineHeight: 1.1, margin: 0, maxWidth: '1000px' }}>
            Korean Convenience Store Meal Builder
          </h1>
          <p style={{ fontSize: 32, color: 'rgba(255, 255, 255, 0.9)', lineHeight: 1.3, margin: 0, maxWidth: '900px' }}>
            Build perfect combos from GS25, CU & 7-Eleven! Mix ramen, kimbap, drinks & snacks!
          </p>
        </div>
