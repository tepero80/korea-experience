    ...
    return (
      ...
      >
        <div ref={resultRef} className="max-w-2xl mx-auto space-y-6">
          {/* Result Header */}
          <div className="bg-gradient-to-br from-amber-600 to-orange-600 rounded-3xl p-8 text-center text-white shadow-2xl">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="w-full bg-gray-200 rounded-full h-3">
            <div
              className="bg-gradient-to-r from-amber-600 to-orange-600 h-3 rounded-full transition-all duration-300 ease-out"
