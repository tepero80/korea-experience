      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Input Form */}
            <div className="bg-white rounded-2xl p-8 shadow-xl border-2 border-amber-100 mb-12">
            ...
            {generatedNames.length > 0 && selectedName && (
              <>
                ...
                <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 shadow-xl border-2 border-amber-200 mb-8">
                  <div className="text-center mb-8">
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white px-4 py-2 rounded-full mb-4">
                      <span className="text-sm font-bold">✨ Your Korean Name</span>
                    </div>
                    
                    <div className="text-7xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-orange-600 mb-4">
                    ...
                    <div className="mb-6">
                      <span className={`
                        ...
                        ${selectedName.gender === 'male' ? 'bg-amber-100 text-amber-700' : 
                          selectedName.gender === 'female' ? 'bg-orange-100 text-orange-700' : 
                ...
                <div className="bg-gradient-to-r from-amber-100 to-orange-100 rounded-2xl p-8 text-center border-2 border-amber-200 mb-12">
